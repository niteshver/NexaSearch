...
- 
TimedeltaIndex.round(*freq* ,*ambiguous='raise'* ,*nonexistent='raise'* )[source]#
- Perform round operation on the data to the specified freq. This method rounds each datetime value in the Series/Index to the nearest specified frequency using standard rounding rules (round half to even). 
  - Parameters:
    - **freq** str or Offset
