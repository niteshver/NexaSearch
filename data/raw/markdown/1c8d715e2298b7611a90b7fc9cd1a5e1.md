...
| `Timestamp.as_unit` | Convert the underlying int64 representaton to the given unit. | 
...
| `Timedelta.as_unit` | Convert the underlying int64 representaton to the given unit. | 
