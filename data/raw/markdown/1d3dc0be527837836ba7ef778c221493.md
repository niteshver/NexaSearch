...
RoboCOIN⟨28⟩
/
AI2_Alphabot_2_pour_mung_beans⟨29⟩
like 0
Follow
![⟨30⟩] BAAI-RoboCOIN 47
Tasks:  Robotics ⟨31⟩
...
Traceback:    Traceback (most recent call last):
              ...
              FileNotFoundError: Couldn't find any data file at /src/services/worker/RoboCOIN/AI2_Alphabot_2_pour_mung_beans. Couldn't find 'RoboCOIN/AI2_Alphabot_2_pour_mung_beans' on the Hugging Face Hub either: FileNotFoundError: Unable to find 'hf://datasets/RoboCOIN/AI2_Alphabot_2_pour_mung_beans@60d194bc3deda37f786b0fb8b784e696f8959c1e/data/chunk-{id}/episode_{id}.parquet' with any supported extension ['.csv', '.tsv', '.json', '.jsonl', '.ndjson', '.parquet', '.geoparquet', '.gpq', '.arrow', '.txt', '.conll', '.conllu', '.tar', '.xml', '.hdf5', '.h5', '.eval', '.lance', '.tsfile', '.blp', '.bmp', '.dib', '.bufr', '.cur', '.pcx', '.dcx', '.dds', '.ps', '.eps', '.fit', '.fits', '.fli', '.flc', '.ftc', '.ftu', '.gbr', '.gif', '.grib', '.png', '.apng', '.jp2', '.j2k', '.jpc', '.jpf', '.jpx', '.j2c', '.icns', '.ico', '.im', '.iim', '.tif', '.tiff', '.jfif', '.jpe', '.jpg', '.jpeg', '.mpg', '.mpeg', '.msp', '.pcd', '.pxr', '.pbm', '.pgm', '.ppm', '.pnm', '.psd', '.bw', '.rgb', '.rgba', '.sgi', '.ras', '.tga', '.icb', '.vda', '.vst', '.webp', '.wmf', '.emf', '.xbm', '.xpm', '.BLP', '.BMP', '.DIB', '.BUFR', '.CUR', '.PCX', '.DCX', '.DDS', '.PS', '.EPS', '.FIT', '.FITS', '.FLI', '.FLC', '.FTC', '.FTU', '.GBR', '.GIF', '.GRIB', '.PNG', '.APNG', '.JP2', '.J2K', '.JPC', '.JPF', '.JPX', '.J2C', '.ICNS', '.ICO', '.IM', '.IIM', '.TIF', '.TIFF', '.JFIF', '.JPE', '.JPG', '.JPEG', '.MPG', '.MPEG', '.MSP', '.PCD', '.PXR', '.PBM', '.PGM', '.PPM', '.PNM', '.PSD', '.BW', '.RGB', '.RGBA', '.SGI', '.RAS', '.TGA', '.ICB', '.VDA', '.VST', '.WEBP', '.WMF', '.EMF', '.XBM', '.XPM', '.aiff', '.au', '.avr', '.caf', '.flac', '.htk', '.svx', '.mat4', '.mat5', '.mpc2k', '.ogg', '.paf', '.pvf', '.raw', '.rf64', '.sd2', '.sds', '.ircam', '.voc', '.w64', '.wav', '.nist', '.wavex', '.wve', '.xi', '.mp3', '.opus', '.3gp', '.3g2', '.avi', '.asf', '.flv', '.mp4', '.mov', '.m4v', '.mkv', '.webm', '.f4v', '.wmv', '.wma', '.ogm', '.mxf', '.nut', '.AIFF', '.AU', '.AVR', '.CAF', '.FLAC', '.HTK', '.SVX', '.MAT4', '.MAT5', '.MPC2K', '.OGG', '.PAF', '.PVF', '.RAW', '.RF64', '.SD2', '.SDS', '.IRCAM', '.VOC', '.W64', '.WAV', '.NIST', '.WAVEX', '.WVE', '.XI', '.MP3', '.OPUS', '.3GP', '.3G2', '.AVI', '.ASF', '.FLV', '.MP4', '.MOV', '.M4V', '.MKV', '.WEBM', '.F4V', '.WMV', '.WMA', '.OGM', '.MXF', '.NUT', '.glb', '.ply', '.stl', '.GLB', '.PLY', '.STL', '.pdf', '.PDF', '.nii', '.NII', '.zip', '.idx', '.manifest', '.txn']
```
...
#   ⟨75⟩ AI2_Alphabot_2_pour_mung_beans 
...
###   ⟨41⟩ Overview 
  ...
  * **Objects:** `mung bean(green)`, `plastic bowl(pink)`, `plastic cup(purple)`
  * **Task Description:** Pick up the cup and pour the mung beans from the cup into the bowl.


###   ⟨42⟩ Primary Task Instruction 
> Pick up the cup and pour the mung beans from the cup into the bowl.
...
##   ⟨47⟩ Task Descriptions 
  * **Standardized Task Description:** `Pick up the cup and pour the mung beans from the cup into the bowl.`
...
This dataset includes 1 distinct subtasks:
  1. **Pick up the cup and pour the mung beans from the cup into the bowl.**
...
```
AI2_Alphabot_2_pour_mung_beans_0_qced_hardlink/
|-- annotations
|   |-- camera_params.json
...
Downloads last month
    1,141
Total file size: 8.02 GB
##  Paper for RoboCOIN/AI2_Alphabot_2_pour_mung_beans
