...
# 
 ![](https://huggingface.co/avatars/baa3bb09f47271899ae64ee49961d98a.svg) ⟨28⟩
arahman4710⟨28⟩
/
trained_model1⟨29⟩
like 0
 Token Classification ⟨30⟩ Transformers ⟨31⟩ Safetensors ⟨32⟩ xlm-roberta ⟨33⟩
arxiv: 1910.09700
 Model card ⟨29⟩ Files Files and versions xet ⟨34⟩ Community ⟨35⟩
Deploy
Copy to bucket new
Use this model
### Instructions to use arahman4710/trained_model1 with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  * Libraries
  *  Transformers⟨36⟩
How to use arahman4710/trained_model1 with Transformers:

```
# Use a pipeline as a high-level helper
from transformers import pipeline

pipe = pipeline("token-classification", model="arahman4710/trained_model1")
```
...
tokenizer = AutoTokenizer.from_pretrained("arahman4710/trained_model1")
model = AutoModelForTokenClassification.from_pretrained("arahman4710/trained_model1", device_map="auto")
```
...
##  Paper for arahman4710/trained_model1
