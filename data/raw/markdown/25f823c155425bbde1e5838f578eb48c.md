...
- Convert structured or record ndarray to DataFrame. Creates a DataFrame object from a structured ndarray, or iterable of tuples or dicts. 
  - Parameters:
    - **data** structured ndarray, iterable of tuples or dicts, or dict
    - Structured input data. Deprecated since version 3.1.0: Passing a dict is deprecated. Use the DataFrame constructor or `DataFrame.from_dict()` instead.
