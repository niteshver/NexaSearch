...
| Series.agg() and DataFrame.agg() | Series or DataFrame | Scalar or Series | Aggregate and summarize values, e.g., sum or custom reducer | 
...
Some of these methods can also be applied to groupby, resample, and various window objects. See Group by: split-apply-combine, resample(), rolling(), expanding(), and ewm() for details.
