...
- 
*class* `sklearn.feature_selection.``SelectFpr` (*score_func=<function f_classif at 0x2b80949fb578>* ,*alpha=0.05* )[source]¶
- Filter: Select the pvalues below alpha based on a FPR test. FPR test stands for False Positive Rate test. It controls the total amount of false detections. Parameters: **score_func** : callableFunction taking two arrays X and y, and returning a pair of arrays (scores, pvalues). **alpha** : float, optionalThe highest p-value for features to be kept. Attributes: **scores_** : array-like, shape=(n_features,)Scores of features. **pvalues_** : array-like, shape=(n_features,)p-values of feature scores. See also 
  - `f_classif`
