# pandas.api.typing.DataFrameGroupBy.rank#

- 
DataFrameGroupBy.rank(*method='average'* ,*ascending=True* ,*na_option='keep'* ,*pct=False* )[source]#
- Provide the rank of values within each group. This method assigns ranks to values within each group, with options for handling duplicate values, NaN values, and computing percentage ranks. 
  - Parameters:
 ...
 See also 
  - `Series.rank`
  - Apply function rank to a Series.
  - `DataFrame.rank`
  - Apply function rank to each row or column of a DataFrame.
