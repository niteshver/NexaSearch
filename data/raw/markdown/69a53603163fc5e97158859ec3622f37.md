...
with`\input{table.tex}` .Changed in version 1.0.0: Added caption and label arguments. Changed in version 1.2.0: Added position argument, changed meaning of caption argument. 
  - Parameters
...
if a single string is passed, no short caption will be set.New in version 1.0.0. Changed in version 1.2.0: Optionally allow caption to be a tuple `(full_caption, short_caption)` .
    - **label** str, optional
    - The LaTeX label to be placed inside `\label{}` in the output.
This is used with`\ref{}` in the main`.tex` file.New in version 1.0.0.
