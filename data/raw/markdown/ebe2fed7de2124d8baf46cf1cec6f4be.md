...
- Perform ceil operation on the data to the specified freq. This method rounds each datetime value in the Series/Index up to the specified frequency (i.e., towards positive infinity). 
  - Parameters:
    - **freq** str or Offset
