...
## Empirical Study of Dropout Scheme for Neural Machine Translation⟨25⟩
Xiaolin Wang⟨26⟩, Masao Utiyama⟨27⟩, Eiichiro Sumita⟨28⟩
...
![](https://aclanthology.org/2017.mtsummit-papers.1/)⟨2⟩
...
Bibkey:
    wang-etal-2017-empirical 

Cite (ACL):
    Xiaolin Wang, Masao Utiyama, and Eiichiro Sumita. 2017. Empirical Study of Dropout Scheme for Neural Machine Translation⟨33⟩. In _Proceedings of Machine Translation Summit XVI: Research Track_ , pages 1–14, Nagoya Japan. 

Cite (Informal):
    Empirical Study of Dropout Scheme for Neural Machine Translation⟨33⟩ (Wang et al., MTSummit 2017) 

Copy Citation:
     BibTeX Markdown MODS XML Endnote More options… 

PDF:
    <https://aclanthology.org/2017.mtsummit-papers.1.pdf>
...
<mods ID="wang-etal-2017-empirical">
    <titleInfo>
    ...
    <identifier type="citekey">wang-etal-2017-empirical</identifier>
    <location>
        <url>https://aclanthology.org/2017.mtsummit-papers.1/</url>
    </location>
    <part>
...
%T Empirical Study of Dropout Scheme for Neural Machine Translation
%A Wang, Xiaolin
%A Utiyama, Masao
%A Sumita, Eiichiro
%Y Kurohashi, Sadao
...
%8 sep 18 – sep 22
%C Nagoya Japan
%F wang-etal-2017-empirical
%U https://aclanthology.org/2017.mtsummit-papers.1/
%P 1-14
```
