...
- Indicator for whether the date is the first day of a quarter. This boolean attribute evaluates to True if the date falls on the first day of a calendar quarter (January 1, April 1, July 1, or October 1), and False otherwise. 
  - Returns:
