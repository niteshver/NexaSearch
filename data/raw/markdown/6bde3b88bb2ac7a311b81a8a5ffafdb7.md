...
#   ⟨43⟩ Oracle Turret — Français (fr) 
LJSpeech dataset of Oracle Turret (fr).
  * **23** pairs
...
python3 -m piper_train.preprocess \
  --language fr \
  --input-dir ./oracle_turret_fr \
  --output-dir ./train_oracle_turret_fr \
...
python3 -m piper_train \
  --dataset-dir ./train_oracle_turret_fr \
  --accelerator 'gpu' \
  --devices 1 \
  --quality high \
  --batch-size 16 \
