...
## A Target Attention Model for Neural Machine Translation⟨25⟩
Hideya Mino⟨26⟩, Andrew Finch⟨27⟩, Eiichiro Sumita⟨28⟩
...
![](https://aclanthology.org/2017.mtsummit-papers.2/)⟨2⟩
...
Bibkey:
    mino-etal-2017-target 

Cite (ACL):
    Hideya Mino, Andrew Finch, and Eiichiro Sumita. 2017. A Target Attention Model for Neural Machine Translation⟨33⟩. In _Proceedings of Machine Translation Summit XVI: Research Track_ , pages 15–26, Nagoya Japan. 

Cite (Informal):
    A Target Attention Model for Neural Machine Translation⟨33⟩ (Mino et al., MTSummit 2017) 

Copy Citation:
     BibTeX Markdown MODS XML Endnote More options… 

PDF:
    <https://aclanthology.org/2017.mtsummit-papers.2.pdf>
...
<mods ID="mino-etal-2017-target">
    ...
    <identifier type="citekey">mino-etal-2017-target</identifier>
    <location>
        <url>https://aclanthology.org/2017.mtsummit-papers.2/</url>
    </location>
    <part>
...
%T A Target Attention Model for Neural Machine Translation
%A Mino, Hideya
%A Finch, Andrew
%A Sumita, Eiichiro
%Y Kurohashi, Sadao
...
%8 sep 18 – sep 22
%C Nagoya Japan
%F mino-etal-2017-target
%U https://aclanthology.org/2017.mtsummit-papers.2/
%P 15-26
```
