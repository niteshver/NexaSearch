...
## Neural Pre-Translation for Hybrid Machine Translation⟨25⟩
Jinhua Du⟨26⟩, Andy Way⟨27⟩
...
![](https://aclanthology.org/2017.mtsummit-papers.3/)⟨2⟩
...
Cite (ACL):
    Jinhua Du and Andy Way. 2017. Neural Pre-Translation for Hybrid Machine Translation⟨32⟩. In _Proceedings of Machine Translation Summit XVI: Research Track_ , pages 27–40, Nagoya Japan. 

Cite (Informal):
    Neural Pre-Translation for Hybrid Machine Translation⟨32⟩ (Du & Way, MTSummit 2017) 

Copy Citation:
     BibTeX Markdown MODS XML Endnote More options… 

PDF:
    <https://aclanthology.org/2017.mtsummit-papers.3.pdf>
...
<mods ID="du-way-2017-neural">
    ...
    <identifier type="citekey">du-way-2017-neural</identifier>
    <location>
        <url>https://aclanthology.org/2017.mtsummit-papers.3/</url>
    </location>
    <part>
...
%T Neural Pre-Translation for Hybrid Machine Translation
%A Du, Jinhua
%A Way, Andy
%Y Kurohashi, Sadao
%Y Fung, Pascale
...
%8 sep 18 – sep 22
%C Nagoya Japan
%F du-way-2017-neural
%U https://aclanthology.org/2017.mtsummit-papers.3/
%P 27-40
```
