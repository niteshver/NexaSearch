...
## Generative latent neural models for automatic word alignment⟨25⟩
Anh Khoa Ngo Ho⟨26⟩, François Yvon⟨27⟩
...
![](https://aclanthology.org/2020.amta-research.6/)⟨2⟩
...
Cite (ACL):
    Anh Khoa Ngo Ho and François Yvon. 2020. Generative latent neural models for automatic word alignment⟨32⟩. In _Proceedings of the 14th Conference of the Association for Machine Translation in the Americas (Volume 1: Research Track)_ , pages 64–77, Virtual. Association for Machine Translation in the Americas. 

Cite (Informal):
    Generative latent neural models for automatic word alignment⟨32⟩ (Ngo Ho & Yvon, AMTA 2020) 

Copy Citation:
     BibTeX Markdown MODS XML Endnote More options… 

PDF:
    <https://aclanthology.org/2020.amta-research.6.pdf>
...
<mods ID="ngo-ho-yvon-2020-generative">
    <titleInfo>
        <title>Generative latent neural models for automatic word alignment</title>
    </titleInfo>
    <name type="personal">
    ...
    <identifier type="citekey">ngo-ho-yvon-2020-generative</identifier>
    <location>
        <url>https://aclanthology.org/2020.amta-research.6/</url>
    </location>
    <part>
        <date>2020-10</date>
        <extent unit="page">
...
%T Generative latent neural models for automatic word alignment
%A Ngo Ho, Anh Khoa
%A Yvon, François
%Y Denkowski, Michael
...
%C Virtual
%F ngo-ho-yvon-2020-generative
%U https://aclanthology.org/2020.amta-research.6/
%P 64-77
```
