...
```
- 
            Air quality Nitrate dataFor this tutorial, air quality data about The To raw data`air_quality_no2_long.csv` data set provides*FR04014* ,*BETR801* and*London
...
- 
    Air quality Particulate matter dataFor this tutorial, air quality data about Particulate matter less than 2.5 micrometers is used, made available by OpenAQ and downloaded using the py-openaq package. The To raw data`air_quality_pm25_long.csv` data set provides*FR04014* ,*BETR801* and*London
...
- I want to combine the measurements of In [8]: air_quality = pd.concat([air_quality_pm25, air_quality_no2], axis=0) In [9]: air_quality.head() Out[9]: date.utc location parameter value 0 2019-06-18 06:00:00+00:00 BETR801 pm25 18.0 1 2019-06-17 08:00:00+00:00 BETR801 pm25 6.5 2 2019-06-17 07:00:00+00:00 BETR801 pm25 18.5 3 2019-06-17 06:00:00+00:00 BETR801 pm25 16.0 4 2019-06-17 05:00:00+00:00 BETR801 pm25 7.5 The `concat()` function performs concatenation operations of multiple
