...
- Indicates whether the date is the last day of the month. This boolean attribute evaluates to True if the date falls on the last day of a calendar month, and False otherwise. 
  - Returns:
    - Series or array
