...
## Emotion Analysis from Texts⟨25⟩
Sanja Stajner⟨26⟩, Roman Klinger⟨27⟩
...
![](https://aclanthology.org/2023.eacl-tutorials.2/)⟨2⟩
...
DOI:
    10.18653/v1/2023.eacl-tutorials.2⟨32⟩ 

Bibkey:
    stajner-klinger-2023-emotion 

Cite (ACL):
    Sanja Stajner and Roman Klinger. 2023. Emotion Analysis from Texts⟨33⟩. In _Proceedings of the 17th Conference of the European Chapter of the Association for Computational Linguistics: Tutorial Abstracts_ , pages 7–12, Dubrovnik, Croatia. Association for Computational Linguistics. 

Cite (Informal):
    Emotion Analysis from Texts⟨33⟩ (Stajner & Klinger, EACL 2023) 
...
Video:
     https://aclanthology.org/2023.eacl-tutorials.2.mp4⟨34⟩
...
<mods ID="stajner-klinger-2023-emotion">
    <titleInfo>
    ...
    <identifier type="citekey">stajner-klinger-2023-emotion</identifier>
    <identifier type="doi">10.18653/v1/2023.eacl-tutorials.2</identifier>
    <location>
        <url>https://aclanthology.org/2023.eacl-tutorials.2/</url>
    </location>
    <part>
        <date>2023-05</date>
        <extent unit="page">
...
%C Dubrovnik, Croatia
%F stajner-klinger-2023-emotion
%X Emotion analysis in text is an area of research that encompasses a set of various natural language processing (NLP) tasks, including classification and regression settings, as well as structured prediction tasks like role labelling or stimulus detection. In this tutorial, we provide an overview of research from emotion psychology which sets the ground for choosing adequate NLP methodology, and present existing resources and classification methods used for emotion analysis in texts. We further discuss appraisal theories and how events can be interpreted regarding their presumably caused emotion and briefly introduce emotion role labelling. In addition to these technical topics, we discuss the use cases of emotion analysis in text, their societal impact, ethical considerations, as well as the main challenges in the field.
%R 10.18653/v1/2023.eacl-tutorials.2
%U https://aclanthology.org/2023.eacl-tutorials.2/
%U https://doi.org/10.18653/v1/2023.eacl-tutorials.2
%P 7-12
```
