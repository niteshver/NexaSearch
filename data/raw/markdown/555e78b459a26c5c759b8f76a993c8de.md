...
# 
 ![](https://huggingface.co/avatars/7bda737167bd54d6c48146c3c0fe6d14.svg) ⟨28⟩
asfafaf4546⟨28⟩
/
...
Copy to bucket new
Use this model
### Instructions to use asfafaf4546/MyAwesomeModel-TestRepo with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  * Libraries
  *  Transformers⟨36⟩
How to use asfafaf4546/MyAwesomeModel-TestRepo with Transformers:

```
# Use a pipeline as a high-level helper
from transformers import pipeline

pipe = pipeline("feature-extraction", model="asfafaf4546/MyAwesomeModel-TestRepo")
```
...
tokenizer = AutoTokenizer.from_pretrained("asfafaf4546/MyAwesomeModel-TestRepo")
model = AutoModel.from_pretrained("asfafaf4546/MyAwesomeModel-TestRepo", device_map="auto")
```
...
![MyAwesomeModel⟨51⟩]
* * *
 ![License](https://huggingface.co/asfafaf4546/MyAwesomeModel-TestRepo/resolve/main/figures/fig2.png) ⟨52⟩
##   ⟨40⟩ 1. Introduction 
