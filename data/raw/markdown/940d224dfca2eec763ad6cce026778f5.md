...
- 
TimedeltaIndex.floor(*freq* ,*ambiguous='raise'* ,*nonexistent='raise'* )[source]#
- Perform floor operation on the data to the specified freq. This method rounds each datetime value in the Series/Index down to the specified frequency (i.e., towards negative infinity). 
  - Parameters:
    - **freq** str or Offset
