...
## Paying Attention to Multi-Word Expressions in Neural Machine Translation⟨25⟩
Matīss Rikters⟨26⟩, Ondřej Bojar⟨27⟩
...
![](https://aclanthology.org/2017.mtsummit-papers.7/)⟨2⟩
...
Bibkey:
    rikters-bojar-2017-paying 

Cite (ACL):
    Matīss Rikters and Ondřej Bojar. 2017. Paying Attention to Multi-Word Expressions in Neural Machine Translation⟨32⟩. In _Proceedings of Machine Translation Summit XVI: Research Track_ , pages 86–95, Nagoya Japan. 

Cite (Informal):
    Paying Attention to Multi-Word Expressions in Neural Machine Translation⟨32⟩ (Rikters & Bojar, MTSummit 2017) 

Copy Citation:
     BibTeX Markdown MODS XML Endnote More options… 

PDF:
    <https://aclanthology.org/2017.mtsummit-papers.7.pdf>
...
<mods ID="rikters-bojar-2017-paying">
    <titleInfo>
    ...
    <identifier type="citekey">rikters-bojar-2017-paying</identifier>
    <location>
        <url>https://aclanthology.org/2017.mtsummit-papers.7/</url>
    </location>
    <part>
...
%T Paying Attention to Multi-Word Expressions in Neural Machine Translation
%A Rikters, Matīss
%A Bojar, Ondřej
%Y Kurohashi, Sadao
%Y Fung, Pascale
...
%8 sep 18 – sep 22
%C Nagoya Japan
%F rikters-bojar-2017-paying
%U https://aclanthology.org/2017.mtsummit-papers.7/
%P 86-95
```
