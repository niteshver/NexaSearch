...
- Draw bar chart in the cell backgrounds. Renders horizontal bars as CSS gradients within table cells, proportional to the underlying cell values. Colors can be customized with a single color, a positive/negative pair, or a colormap. 
  - Parameters:
