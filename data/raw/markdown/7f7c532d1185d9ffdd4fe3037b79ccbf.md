...
## Neural and Statistical Methods for Leveraging Meta-information in Machine Translation⟨25⟩
Shahram Khadivi⟨26⟩, Patrick Wilken⟨27⟩, Leonard Dahlmann⟨28⟩, Evgeny Matusov⟨29⟩
...
![](https://aclanthology.org/2017.mtsummit-papers.4/)⟨2⟩
...
Bibkey:
    khadivi-etal-2017-neural 

Cite (ACL):
    Shahram Khadivi, Patrick Wilken, Leonard Dahlmann, and Evgeny Matusov. 2017. Neural and Statistical Methods for Leveraging Meta-information in Machine Translation⟨34⟩. In _Proceedings of Machine Translation Summit XVI: Research Track_ , pages 41–54, Nagoya Japan. 

Cite (Informal):
    Neural and Statistical Methods for Leveraging Meta-information in Machine Translation⟨34⟩ (Khadivi et al., MTSummit 2017) 

Copy Citation:
     BibTeX Markdown MODS XML Endnote More options… 

PDF:
    <https://aclanthology.org/2017.mtsummit-papers.4.pdf>
...
<mods ID="khadivi-etal-2017-neural">
    <titleInfo>
    ...
    <name type="personal">
        ...
        <namePart type="family">Dahlmann</namePart>
        <role>
            <roleTerm authority="marcrelator" type="text">author</roleTerm>
        </role>
    </name>
    ...
    <identifier type="citekey">khadivi-etal-2017-neural</identifier>
    <location>
        <url>https://aclanthology.org/2017.mtsummit-papers.4/</url>
    </location>
    <part>
...
%T Neural and Statistical Methods for Leveraging Meta-information in Machine Translation
%A Khadivi, Shahram
%A Wilken, Patrick
%A Dahlmann, Leonard
%A Matusov, Evgeny
...
%8 sep 18 – sep 22
%C Nagoya Japan
%F khadivi-etal-2017-neural
%U https://aclanthology.org/2017.mtsummit-papers.4/
%P 41-54
```
