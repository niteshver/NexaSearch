...
on the rows and columns.
    ...
    - This only applies if any of the groupers are Categoricals. If True: only show observed values for categorical groupers. If False: show all values for categorical groupers. Deprecated since version 2.2.0: The default value of `False` is deprecated and will change to`True` in a future version of pandas.
    - **sort** bool, default True
    - Specifies if the result should be sorted. Added in version 1.3.0.
  - Returns:
    - DataFrame
