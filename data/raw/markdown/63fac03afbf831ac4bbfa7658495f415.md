...
- Make a MultiIndex from the cartesian product of multiple iterables. 
  - Parameters
    ...
    - Names for the levels in the index. Changed in version 1.0.0: If not explicitly provided, names will be inferred from the elements of iterables if an element has a name attribute
  - Returns
    - MultiIndex
 See also 
