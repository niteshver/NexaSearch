...
- Return index of first occurrence of minimum over requested axis. NA/null values are excluded. 
  - Parameters:
    ...
    - Exclude NA/null values. If the entire DataFrame is NA, or if `skipna=False` and there is an NA value, this method
