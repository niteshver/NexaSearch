...
/
arc-agi3-agy-kimi2.7-thinking-tr87⟨29⟩
like 0
Follow
...
#   ⟨46⟩ ARC-AGI-3 `tr87` — Agent Trajectories (`agy-kimi2.7-thinking`) 
Gameplay trajectories from the harness×model pair `agy-kimi2.7-thinking` playing the ARC-AGI-3⟨47⟩ game `tr87`, part of the ARA-as-world-model generalization experiment. The agent builds a structured world model (an Agent-Native Research Artifact) live during play and consults it to crack levels it cannot solve from cold exploration.
