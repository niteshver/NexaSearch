# pandas.api.typing.Rolling.aggregate#

- 
Rolling.aggregate(*func=None* ,**args* ,***kwargs* )[source]#
- Aggregate using one or more operations over the specified axis. This method allows combining multiple aggregation functions (e.g. `'sum'` ,`'mean'` ) in a single call, returning a result for each
