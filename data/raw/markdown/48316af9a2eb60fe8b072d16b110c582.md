...
## Domain Robustness in Neural Machine Translation⟨25⟩
Mathias Müller⟨26⟩, Annette Rios⟨27⟩, Rico Sennrich⟨28⟩
...
![](https://aclanthology.org/2020.amta-research.14/)⟨2⟩
...
Bibkey:
    muller-etal-2020-domain 

Cite (ACL):
    Mathias Müller, Annette Rios, and Rico Sennrich. 2020. Domain Robustness in Neural Machine Translation⟨33⟩. In _Proceedings of the 14th Conference of the Association for Machine Translation in the Americas (Volume 1: Research Track)_ , pages 151–164, Virtual. Association for Machine Translation in the Americas. 

Cite (Informal):
    Domain Robustness in Neural Machine Translation⟨33⟩ (Müller et al., AMTA 2020) 

Copy Citation:
     BibTeX Markdown MODS XML Endnote More options… 

PDF:
    <https://aclanthology.org/2020.amta-research.14.pdf>
...
<mods ID="muller-etal-2020-domain">
    <titleInfo>
    ...
    <identifier type="citekey">muller-etal-2020-domain</identifier>
    <location>
        <url>https://aclanthology.org/2020.amta-research.14/</url>
    </location>
    <part>
        <date>2020-10</date>
        <extent unit="page">
...
%T Domain Robustness in Neural Machine Translation
%A Müller, Mathias
%A Rios, Annette
%A Sennrich, Rico
%Y Denkowski, Michael
...
%C Virtual
%F muller-etal-2020-domain
%U https://aclanthology.org/2020.amta-research.14/
%P 151-164
```
