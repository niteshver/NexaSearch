...
## Joint Dropout: Improving Generalizability in Low-Resource Neural Machine Translation through Phrase Pair Variables⟨25⟩
...
![](https://aclanthology.org/2023.mtsummit-research.2/)⟨2⟩
...
Bibkey:
    araabi-etal-2023-joint 

Cite (ACL):
    Ali Araabi, Vlad Niculae, and Christof Monz. 2023. Joint Dropout: Improving Generalizability in Low-Resource Neural Machine Translation through Phrase Pair Variables⟨33⟩. In _Proceedings of Machine Translation Summit XIX, Vol. 1: Research Track_ , pages 12–25, Macau SAR, China. Asia-Pacific Association for Machine Translation. 

Cite (Informal):
    Joint Dropout: Improving Generalizability in Low-Resource Neural Machine Translation through Phrase Pair Variables⟨33⟩ (Araabi et al., MTSummit 2023) 
