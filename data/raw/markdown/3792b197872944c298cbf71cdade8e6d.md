...
- Return unbiased variance over requested axis. Normalized by N-1 by default. This can be changed using the ddof argument. 
  - Parameters:
    ...
    - Axis for the function to be applied on. For Series this parameter is unused and defaults to 0. Warning The behavior of DataFrame.var with `axis=None` is deprecated,
