...
# 
 ![](https://huggingface.co/avatars/3bb32f6c160ecccc60bcf7245f156275.svg) ⟨28⟩
batoulabdelraheem⟨28⟩
/
my-summarization-model⟨29⟩
like 0
 Transformers ⟨30⟩ Safetensors ⟨31⟩ bart ⟨32⟩ text2text-generation ⟨33⟩
arxiv: 1910.09700
 Model card ⟨29⟩ Files Files and versions xet ⟨34⟩ Community ⟨35⟩
Deploy
Copy to bucket new
Use this model
### Instructions to use batoulabdelraheem/my-summarization-model with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  * Libraries
  *  Transformers⟨36⟩
How to use batoulabdelraheem/my-summarization-model with Transformers:

```
# Load model directly
from transformers import AutoTokenizer, AutoModelForSeq2SeqLM

tokenizer = AutoTokenizer.from_pretrained("batoulabdelraheem/my-summarization-model")
model = AutoModelForSeq2SeqLM.from_pretrained("batoulabdelraheem/my-summarization-model", device_map="auto")
```
...
This model isn't deployed by any Inference Provider. 🙋 Ask for provider support⟨79⟩
##  Paper for batoulabdelraheem/my-summarization-model
#### Quantifying the Carbon Emissions of Machine Learning Paper • 1910.09700 • Published Oct 21, 2019 • 59 ⟨80⟩
System theme
Company
