...
- Create index with target’s values. Optionally provides an indexer that maps the new labels back to the original positions, and supports filling methods for non-exact matches. 
  - Parameters:
    - **target** an iterable
...
inexact matches.
 ...
 Examples >>> idx = pd.Index(["car", "bike", "train", "tractor"]) >>> idx Index(['car', 'bike', 'train', 'tractor'], dtype='str') >>> idx.reindex(["car", "bike"]) (Index(['car', 'bike'], dtype='str'), array([0, 1]))