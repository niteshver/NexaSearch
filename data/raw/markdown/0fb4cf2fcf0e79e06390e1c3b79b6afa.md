...
Dimitrios Kokkinakis⟨26⟩, Kathleen C. Fraser⟨27⟩, Charalambos K. Themistocleous⟨28⟩, Kristina Lundholm Fors⟨29⟩, Athanasios Tsanas⟨30⟩, Fredrik Ohman⟨31⟩ (Editors)
* * * 
...
Events:
     The 2024 Joint International Conference on Computational Linguistics, Language Resources and Evaluation (LREC-COLING 2024)⟨34⟩ | The 2024 Joint International Conference on Computational Linguistics, Language Resources and Evaluation (LREC-COLING 2024)⟨35⟩ | RaPID Workshop - Resources and ProcessIng of linguistic, para-linguistic and extra-linguistic Data from people with various forms of cognitive/psychiatric/developmental impairments (2024)⟨36⟩ | Other Workshops and Events (2024)⟨37⟩ 
...
URL:
    <https://aclanthology.org/2024.rapid-1/> 

DOI:


Bib Export formats:
     BibTeX⟨38⟩ MODS XML⟨39⟩ EndNote⟨40⟩ 

PDF:
    <https://aclanthology.org/2024.rapid-1.pdf>
PDF (full) ⟨25⟩BibTeX ⟨38⟩Search⟨41⟩
* * *
Show all abstractsHide all abstracts
pdf ⟨42⟩bib ⟨43⟩
**Proceedings of the Fifth Workshop on Resources and ProcessIng of linguistic, para-linguistic and extra-linguistic Data from people with various forms of cognitive/psychiatric/developmental impairments @LREC-COLING 2024⟨44⟩**  
...
pdf ⟨45⟩bib ⟨46⟩abs
**Semantic-based NLP techniques discriminate schizophrenia and Wernicke’s aphasia based on spontaneous speech⟨47⟩**  
Frank Tsiwah⟨48⟩ | Anas Mayya⟨49⟩ | Andreas van Cranenburgh⟨50⟩
...
pdf ⟨51⟩bib ⟨52⟩abs
**Speech Rate and Salient Syllables Position in Spontaneous Speech of Children with Autism Spectrum Disorder⟨53⟩**  
Valentina Saccone⟨54⟩
...
pdf ⟨55⟩bib ⟨56⟩abs
**Cross-Lingual Examination of Language Features and Cognitive Scores From Free Speech⟨57⟩**  
Hali Lindsay⟨58⟩ | Giorgia Albertin⟨59⟩ | Louisa Schwed⟨60⟩ | Nicklas Linz⟨61⟩ | Johannes Tröger⟨62⟩
...
pdf ⟨63⟩bib ⟨64⟩abs
**Speech and Language Biomarkers of Neurodegenerative Conditions: Developing Cross-Linguistically Valid Tools for Automatic Analysis⟨65⟩**  
Iris E. Nowenstein⟨66⟩ | Marija Stanojevic⟨67⟩ | Gunnar Örnólfsson⟨68⟩ | María Kristín Jónsdóttir⟨69⟩ | Bill Simpson⟨70⟩ | Jennifer Sorinas Nerin⟨71⟩ | Bryndís Bergþórsdóttir⟨72⟩ | Kristín Hannesdóttir⟨73⟩ | Jekaterina Novikova⟨74⟩ | Jelena Curcic⟨75⟩
...
pdf ⟨76⟩bib ⟨77⟩abs
**Automatic Detection of Rhythmic Features in Pathological Speech of MCI and Dementia Patients⟨78⟩**  
Marica Belmonte⟨79⟩ | Gloria Gagliardi⟨80⟩ | Dimitrios Kokkinakis⟨26⟩ | Fabio Tamburini⟨81⟩
...
pdf ⟨82⟩bib ⟨83⟩abs
**Open Brain AI. Automatic Language Assessment⟨84⟩**  
Charalambos Themistocleous⟨85⟩
...
pdf ⟨86⟩bib ⟨87⟩abs
**Exploring the Relationship Between Intrinsic Stigma in Masked Language Models and Training Data Using the Stereotype Content Model⟨88⟩**  
Mario Mina⟨89⟩ | Júlia Falcão⟨90⟩ | Aitor Gonzalez-Agirre⟨91⟩
...
pdf ⟨92⟩bib ⟨93⟩abs
**Establishing Control Corpora for Depression Detection in Modern Greek: Methodological Insights⟨94⟩**  
Vivian Stamou⟨95⟩ | George Mikros⟨96⟩ | George Markopoulos⟨97⟩ | Spyridoula Varlokosta⟨98⟩
...
pdf ⟨99⟩bib ⟨100⟩abs ⟨101⟩
**A Preliminary Evaluation of Semantic Coherence and Cohesion in Aphasic and Non-Aphasic Discourse Across Test and Retest⟨102⟩**  
Snigdha Khanna⟨103⟩ | Brielle C. Stark⟨104⟩
...
pdf ⟨105⟩bib ⟨106⟩abs
**Harnessing Linguistic Analysis for ADHD Diagnosis Support: A Stylometric Approach to Self-Defining Memories⟨107⟩**  
Florian Cafiero⟨108⟩ | Juan Barrios Rudloff⟨109⟩ | Simon Gabay⟨110⟩
...
pdf ⟨111⟩bib ⟨112⟩abs
**Crosslinguistic Acoustic Feature-based Dementia Classification Using Advanced Learning Architectures⟨113⟩**  
Anna Seo Gyeong Choi⟨114⟩ | Jin-seo Kim⟨115⟩ | Seo-hee Kim⟨116⟩ | Min Seok Back⟨117⟩ | Sunghye Cho⟨118⟩
