...
AG2307⟨28⟩
/
pengwin-2026-anatomy-segmentation-pelvic-full-res⟨29⟩
like 0
Modalities:  Text ⟨30⟩
Formats:  parquet ⟨31⟩
optimized-parquet
...
Split (2)
train · 136 rows
train (136 rows) validation (34 rows)
SQL
Console
The dataset viewer is not available for this split.
Parquet error: Scan size limit exceeded: attempted to read 751281098 bytes, limit is 300000000 bytes Make sure that 1. the Parquet files contain a page index to enable random access without loading entire row groups2. otherwise use smaller row-group sizes when serializing the Parquet files 
...
Downloads last month
    157
Number of rows: 170 Total file size: 13 GB
System theme
Company
