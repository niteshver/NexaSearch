...
- Set new codes on MultiIndex. Defaults to returning new index. The codes map each index entry to its position in the corresponding level array. This method returns a new MultiIndex with the updated codes. 
  - Parameters:
