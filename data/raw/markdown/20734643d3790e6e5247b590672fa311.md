...
## A Minimal Cognitive Model for Translating and Post-editing⟨25⟩
Moritz Schaeffer⟨26⟩, Michael Carl⟨27⟩
...
![](https://aclanthology.org/2017.mtsummit-papers.12/)⟨2⟩
...
Bibkey:
    schaeffer-carl-2017-minimal 

Cite (ACL):
    Moritz Schaeffer and Michael Carl. 2017. A Minimal Cognitive Model for Translating and Post-editing⟨32⟩. In _Proceedings of Machine Translation Summit XVI: Research Track_ , pages 144–155, Nagoya Japan. 

Cite (Informal):
    A Minimal Cognitive Model for Translating and Post-editing⟨32⟩ (Schaeffer & Carl, MTSummit 2017) 

Copy Citation:
     BibTeX Markdown MODS XML Endnote More options… 

PDF:
    <https://aclanthology.org/2017.mtsummit-papers.12.pdf>
...
<mods ID="schaeffer-carl-2017-minimal">
    <titleInfo>
    ...
    <identifier type="citekey">schaeffer-carl-2017-minimal</identifier>
    <location>
        <url>https://aclanthology.org/2017.mtsummit-papers.12/</url>
    </location>
    <part>
...
%T A Minimal Cognitive Model for Translating and Post-editing
%A Schaeffer, Moritz
%A Carl, Michael
%Y Kurohashi, Sadao
%Y Fung, Pascale
...
%8 sep 18 – sep 22
%C Nagoya Japan
%F schaeffer-carl-2017-minimal
%U https://aclanthology.org/2017.mtsummit-papers.12/
%P 144-155
```
