  ...
  - Parameters:
    ...
    - How to find the values that will be replaced. 
      ...
      - list of str, regex, or numeric: 
        ...
        - Second, if `regex=True` then all of the strings in**both** lists will be interpreted as regexs otherwise they will match
...
this**must** be a nested dictionary or Series.
 See the examples section for examples of each of these.
    ...
    - Maximum size gap to forward or backward fill. Deprecated since version 2.1.0.
    ...
    - The method to use when for replacement, when to_replace is a scalar, list or tuple and value is `None` .Deprecated since version 2.1.0.
  - Returns:
    - Series/DataFrame
