...
Out[21]: TimedeltaIndex(['0 days', '1 days', '2 days', '3 days', '4 days'], dtype='timedelta64[s]', freq=None)
```
Warning
...
dtype: timedelta64[us]
In [67]: y2.mean()
Out[67]: Timedelta('-1 days +16:00:03.333334')
In [68]: y2.median()
...
Out[85]: (Timedelta('0 days 00:00:00'), Timedelta('1 days 01:00:00'))
```
## Attributes#
...
Out[96]: TimedeltaIndex(['0 days', '10 days', '20 days'], dtype='timedelta64[us]', freq='10D')
```
...
Out[97]: TimedeltaIndex(['1 days', '2 days', '3 days', '4 days', '5 days'], dtype='timedelta64[us]', freq='D')
```
...
Out[98]: TimedeltaIndex(['1 days', '2 days', '3 days', '4 days', '5 days'], dtype='timedelta64[us]', freq='D')
In [99]: pd.timedelta_range(end="10 days", periods=4)
Out[99]: TimedeltaIndex(['7 days', '8 days', '9 days', '10 days'], dtype='timedelta64[us]', freq='D')
```
...
Out[102]: TimedeltaIndex(['0 days', '1 days', '2 days', '3 days', '4 days'], dtype='timedelta64[us]', freq=None)
...
Out[118]: DatetimeIndex(['2013-01-02', 'NaT', '2013-01-03'], dtype='datetime64[us]', freq=None)
...
Out[120]: TimedeltaIndex(['11 days', NaT, '12 days'], dtype='timedelta64[us]', freq=None)
# division can result in a Timedelta if the divisor is an integer
In [121]: tdi / 2
Out[121]: TimedeltaIndex(['0 days 12:00:00', NaT, '1 days 00:00:00'], dtype='timedelta64[us]', freq=None)
