...
# 
 ![](https://huggingface.co/avatars/0d76f0f7524f155d81a8d845499d550a.svg) ⟨28⟩
TrivittLetchaw82⟨28⟩
/
...
Copy to bucket new
Use this model
### Instructions to use TrivittLetchaw82/MyAwesomeModel-TestRepo with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  * Libraries
  *  Transformers⟨36⟩
How to use TrivittLetchaw82/MyAwesomeModel-TestRepo with Transformers:

```
# Use a pipeline as a high-level helper
from transformers import pipeline

pipe = pipeline("feature-extraction", model="TrivittLetchaw82/MyAwesomeModel-TestRepo")
```
...
tokenizer = AutoTokenizer.from_pretrained("TrivittLetchaw82/MyAwesomeModel-TestRepo")
model = AutoModel.from_pretrained("TrivittLetchaw82/MyAwesomeModel-TestRepo", device_map="auto")
```
...
![MyAwesomeModel⟨51⟩]
* * *
 ![License](https://huggingface.co/TrivittLetchaw82/MyAwesomeModel-TestRepo/resolve/main/figures/fig2.png) ⟨52⟩
##   ⟨40⟩ 1. Introduction 
