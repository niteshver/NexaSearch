...
- Aggregate using one or more operations over the specified axis. This method allows combining multiple aggregation functions at once, such as `sum` ,`mean` , and`min` , and can apply them either
