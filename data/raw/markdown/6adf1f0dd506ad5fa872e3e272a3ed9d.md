...
# 
 ![](https://huggingface.co/avatars/9044fc0f36af625e50885b1788613101.svg) ⟨28⟩
asdafee34⟨28⟩
/
...
Copy to bucket new
Use this model
### Instructions to use asdafee34/MyAwesomeModel-TestRepo with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  * Libraries
  *  Transformers⟨36⟩
How to use asdafee34/MyAwesomeModel-TestRepo with Transformers:

```
# Use a pipeline as a high-level helper
from transformers import pipeline

pipe = pipeline("feature-extraction", model="asdafee34/MyAwesomeModel-TestRepo")
```
...
tokenizer = AutoTokenizer.from_pretrained("asdafee34/MyAwesomeModel-TestRepo")
model = AutoModel.from_pretrained("asdafee34/MyAwesomeModel-TestRepo", device_map="auto")
```
...
![MyAwesomeModel⟨51⟩]
* * *
 ![License](https://huggingface.co/asdafee34/MyAwesomeModel-TestRepo/resolve/main/figures/fig2.png) ⟨52⟩
##   ⟨40⟩ 1. Introduction 
