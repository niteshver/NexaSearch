...
They wondered if it made sense to add an IPArray to pandas. In the
...
pandas. I was able to write cyberpandas outside of pandas, but it
...
This works perfectly with NumPy's `__array_ufunc__` protocol and
