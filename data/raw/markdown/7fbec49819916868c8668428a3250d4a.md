# pandas.api.typing.DataFrameGroupBy.rolling#

- 
DataFrameGroupBy.rolling(*window* ,*min_periods=None* ,*center=False* ,*win_type=None* ,*on=None* ,*closed=None* ,*method='single'* )[source]#
