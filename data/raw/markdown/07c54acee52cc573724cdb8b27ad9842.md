...
- `DataFrame.__dataframe__()` was producing incorrect data buffers when a column’s type was a pandas nullable one with missing values (GH 56702)
- `DataFrame.__dataframe__()` was producing incorrect data buffers when a column’s type was a pyarrow nullable one with missing values (GH 57664)
