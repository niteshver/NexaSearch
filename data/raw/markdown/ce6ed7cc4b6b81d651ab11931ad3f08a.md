...
```
- Air quality dataFor this tutorial, air quality data about To raw data𝑁  𝑂 2 `air_quality_no2.csv` data set provides𝑁  𝑂 2 *FR04014* ,*BETR801* and*London Westminster* in respectively Paris, Antwerp and London.In [2]: air_quality = pd.read_csv("data/air_quality_no2.csv", index_col=0, parse_dates=True) In [3]: air_quality.head() Out[3]: station_antwerp station_paris station_london datetime 2019-05-07 02:00:00 NaN NaN 23.0 2019-05-07 03:00:00 50.5 25.0 19.0 2019-05-07 04:00:00 45.0 27.7 19.0 2019-05-07 05:00:00 NaN 50.4 16.0 2019-05-07 06:00:00 NaN 61.9 NaN

# How to create new columns derived from existing columns#

- I want to express the 𝑁  𝑂 2 3 ( *If we assume temperature of 25 degrees Celsius and pressure of 1013
