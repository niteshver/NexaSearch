# pandas.api.typing.DataFrameGroupBy.sample#

- 
DataFrameGroupBy.sample(*n=None* ,*frac=None* ,*replace=False* ,*weights=None* ,*random_state=None* )[source]#
- Return a random sample of items from each group. You can use random_state for reproducibility. 
  - Parameters:
    - **n** int, optional
