...
# 
 ![](https://cdn-avatars.huggingface.co/v1/production/uploads/noauth/K2EL0jgciJIAo5pXSpe8l.jpeg) ⟨28⟩
bardiaegz⟨28⟩
/
my-awesome-model⟨29⟩
like 0
 Feature Extraction ⟨30⟩ Transformers ⟨31⟩ Safetensors ⟨32⟩ bert ⟨33⟩
arxiv: 1910.09700
 Model card ⟨29⟩ Files Files and versions xet ⟨34⟩ Community ⟨35⟩
Deploy
Copy to bucket new
Use this model
### Instructions to use bardiaegz/my-awesome-model with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  * Libraries
  *  Transformers⟨36⟩
How to use bardiaegz/my-awesome-model with Transformers:

```
# Use a pipeline as a high-level helper
from transformers import pipeline

pipe = pipeline("feature-extraction", model="bardiaegz/my-awesome-model")
```
...
tokenizer = AutoTokenizer.from_pretrained("bardiaegz/my-awesome-model")
model = AutoModel.from_pretrained("bardiaegz/my-awesome-model", device_map="auto")
```
...
##  Paper for bardiaegz/my-awesome-model
