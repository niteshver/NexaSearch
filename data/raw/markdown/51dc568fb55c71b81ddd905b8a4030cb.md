...
# 
 ![](https://huggingface.co/avatars/98518923fc1ee743aac2fdb585f16e17.svg) ⟨28⟩
XiAT⟨28⟩
/
...
model = AutoModel.from_pretrained("XiAT/MyAwesomeModel-TestRepo", device_map="auto")
```
...
![MyAwesomeModel⟨51⟩]
* * *
 ![License](https://huggingface.co/XiAT/MyAwesomeModel-TestRepo/resolve/main/figures/fig2.png) ⟨52⟩
##   ⟨40⟩ 1. Introduction 
