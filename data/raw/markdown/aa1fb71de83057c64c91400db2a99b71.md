...
exclude pandas categorical columns, use`'category'`
    ...
    - Whether to treat datetime dtypes as numeric. This affects statistics calculated for the column. For DataFrame input, this also controls whether datetime columns are included by default. New in version 1.1.0.
  - Returns
    - Series or DataFrame
