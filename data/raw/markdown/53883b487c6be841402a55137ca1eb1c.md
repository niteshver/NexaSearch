...
## The INLG 2024 Tutorial on Human Evaluation of NLP System Quality: Background, Overall Aims, and Summaries of Taught Units⟨25⟩
...
![](https://aclanthology.org/2024.inlg-tutorials.1/)⟨2⟩
...
DOI:
    10.18653/v1/2024.inlg-tutorials.1⟨34⟩ 

Bibkey:
    belz-etal-2024-inlg 

Cite (ACL):
    Anya Belz, João Sedoc, Craig Thomson, Simon Mille, and Rudali Huidrom. 2024. The INLG 2024 Tutorial on Human Evaluation of NLP System Quality: Background, Overall Aims, and Summaries of Taught Units⟨35⟩. In _Proceedings of the 17th International Natural Language Generation Conference: Tutorial Abstract_ , pages 1–12, Tokyo, Japan. Association for Computational Linguistics. 

Cite (Informal):
    The INLG 2024 Tutorial on Human Evaluation of NLP System Quality: Background, Overall Aims, and Summaries of Taught Units⟨35⟩ (Belz et al., INLG 2024) 
...
@inproceedings{belz-etal-2024-inlg,
    ...
    doi = "10.18653/v1/2024.inlg-tutorials.1",
    pages = "1--12",
...
<mods ID="belz-etal-2024-inlg">
    <titleInfo>
        <title>The INLG 2024 Tutorial on Human Evaluation of NLP System Quality: Background, Overall Aims, and Summaries of Taught Units</title>
    </titleInfo>
    <name type="personal">
    ...
    <abstract>Following numerous calls in the literature for improved practices and standardisation in human evaluation in Natural Language Processing over the past ten years, we held a tutorial on the topic at the 2024 INLG Conference. The tutorial addressed the structure, development, design, implementation, execution and analysis of human evaluations of NLP system quality. Hands-on practical sessions were run, designed to facilitate assimilation of the material presented. Slides, lecture recordings, code and data have been made available on GitHub (https://github.com/Human-Evaluation-Tutorial/INLG-2024-Tutorial). In this paper, we provide summaries of the content of the eight units of the tutorial, alongside its research context and aims.</abstract>
    <identifier type="citekey">belz-etal-2024-inlg</identifier>
    <identifier type="doi">10.18653/v1/2024.inlg-tutorials.1</identifier>
    <location>
        <url>https://aclanthology.org/2024.inlg-tutorials.1/</url>
    </location>
    <part>
        <date>2024-09</date>
        <extent unit="page">
...
%R 10.18653/v1/2024.inlg-tutorials.1
%U https://aclanthology.org/2024.inlg-tutorials.1/
%U https://doi.org/10.18653/v1/2024.inlg-tutorials.1
%P 1-12
```
