...
- Return a Series containing counts of unique rows in the DataFrame. New in version 1.1.0. 
  - Parameters
    ...
    - Don’t include counts of rows that contain NA values. New in version 1.3.0.
  - Returns
    - Series
 See also 
  - `Series.value_counts`
