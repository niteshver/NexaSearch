...
In [144]: %timeit arr[indexer]
   ...
   .....: 
221 us +- 43.3 us per loop (mean +- std. dev. of 7 runs, 1,000 loops each)
43.1 us +- 6.85 us per loop (mean +- std. dev. of 7 runs, 10,000 loops each)
```
```
...
In [146]: %timeit ser.iloc[indexer]
   ...
   .....: 
88 us +- 2.95 us per loop (mean +- std. dev. of 7 runs, 10,000 loops each)
79.6 us +- 5.05 us per loop (mean +- std. dev. of 7 runs, 10,000 loops each)
```
## Index types#
