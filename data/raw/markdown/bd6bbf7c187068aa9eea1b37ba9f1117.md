...
- 
classmethod IntervalArray.from_arrays(*left* ,*right* ,*closed='right'* ,*copy=False* ,*dtype=None* )[source]#
- Construct from two arrays defining the left and right bounds. This method creates an IntervalArray from two arrays of equal length, where the i-th interval spans from left[i] to right[i]. 
  - Parameters:
