...
# 
 ![](https://huggingface.co/avatars/b5c58c4180afb026bb6edbd00fc2d058.svg) ⟨28⟩
asfafafs456⟨28⟩
/
...
Copy to bucket new
Use this model
### Instructions to use asfafafs456/MyAwesomeModel-TestRepo with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  * Libraries
  *  Transformers⟨36⟩
How to use asfafafs456/MyAwesomeModel-TestRepo with Transformers:

```
# Use a pipeline as a high-level helper
from transformers import pipeline

pipe = pipeline("feature-extraction", model="asfafafs456/MyAwesomeModel-TestRepo")
```
...
tokenizer = AutoTokenizer.from_pretrained("asfafafs456/MyAwesomeModel-TestRepo")
model = AutoModel.from_pretrained("asfafafs456/MyAwesomeModel-TestRepo", device_map="auto")
```
...
![MyAwesomeModel⟨51⟩]
* * *
 ![License](https://huggingface.co/asfafafs456/MyAwesomeModel-TestRepo/resolve/main/figures/fig2.png) ⟨52⟩
##   ⟨40⟩ 1. Introduction 
