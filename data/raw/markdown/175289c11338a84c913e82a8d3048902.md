...
# 
 ![](https://huggingface.co/avatars/9ecca05c9b7c6442b113889be2195393.svg) ⟨28⟩
asxfafaf1⟨28⟩
/
...
Copy to bucket new
Use this model
### Instructions to use asxfafaf1/MyAwesomeModel-TestRepo with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  * Libraries
  *  Transformers⟨36⟩
How to use asxfafaf1/MyAwesomeModel-TestRepo with Transformers:

```
# Use a pipeline as a high-level helper
from transformers import pipeline

pipe = pipeline("feature-extraction", model="asxfafaf1/MyAwesomeModel-TestRepo")
```
...
tokenizer = AutoTokenizer.from_pretrained("asxfafaf1/MyAwesomeModel-TestRepo")
model = AutoModel.from_pretrained("asxfafaf1/MyAwesomeModel-TestRepo", device_map="auto")
```
...
![MyAwesomeModel⟨51⟩]
* * *
 ![License](https://huggingface.co/asxfafaf1/MyAwesomeModel-TestRepo/resolve/main/figures/fig2.png) ⟨52⟩
##   ⟨40⟩ 1. Introduction 
