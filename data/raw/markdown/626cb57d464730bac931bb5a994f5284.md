...
- Aggregate using one or more operations over the specified axis. This method applies one or more aggregation functions to the Series and returns a scalar, Series, or DataFrame depending on the function(s) provided. 
  - Parameters:
