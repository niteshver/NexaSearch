...
View PDF HTML (experimental)
            Abstract:  This note records two results which were inexplicably omitted from our paper on Pin structures on low dimensional manifolds, [KT]. Kirby chose not to be listed as a coauthor.
...
In [KT], section 6, a Pin^- structure is constructed on a surface F dual to w_2 in an oriented 4-manifold M^4. Theorem 2.1 says that q vanishes on the Poincare dual to the image of H^1(M^4;Z/2Z) in H^1(F;Z/2Z).
