...
- Whether each element in the DataFrame is contained in values. 
 ...
 Examples >>> df = pd.DataFrame({'num_legs': [2, 4], 'num_wings': [2, 0]}, ... index=['falcon', 'dog']) >>> df num_legs num_wings falcon 2 2 dog 4 0 When `values` is a list check whether every value in the DataFrame
