...
#   ⟨43⟩ Oracle Turret — Español (es) 
LJSpeech dataset of Oracle Turret (es).
  * **23** pairs
...
python3 -m piper_train.preprocess \
  --language es \
  --input-dir ./oracle_turret_es \
  --output-dir ./train_oracle_turret_es \
...
python3 -m piper_train \
  --dataset-dir ./train_oracle_turret_es \
  --accelerator 'gpu' \
  --devices 1 \
  --quality high \
  --batch-size 16 \
