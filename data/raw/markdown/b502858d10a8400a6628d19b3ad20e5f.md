...
# 
 ![](https://huggingface.co/avatars/7bcc5bb045e006bc2b51c9064fd15324.svg) ⟨28⟩
WinderBYZ⟨28⟩
/
...
Copy to bucket new
Use this model
### Instructions to use WinderBYZ/MyAwesomeModel-TestRepo with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  * Libraries
  *  Transformers⟨36⟩
How to use WinderBYZ/MyAwesomeModel-TestRepo with Transformers:

```
# Use a pipeline as a high-level helper
from transformers import pipeline

pipe = pipeline("feature-extraction", model="WinderBYZ/MyAwesomeModel-TestRepo")
```
...
tokenizer = AutoTokenizer.from_pretrained("WinderBYZ/MyAwesomeModel-TestRepo")
model = AutoModel.from_pretrained("WinderBYZ/MyAwesomeModel-TestRepo", device_map="auto")
```
...
![MyAwesomeModel⟨51⟩]
* * *
 ![License](https://huggingface.co/WinderBYZ/MyAwesomeModel-TestRepo/resolve/main/figures/fig2.png) ⟨52⟩
##   ⟨40⟩ 1. Introduction 
