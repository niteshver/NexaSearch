# pandas.api.typing.Expanding.max#

- 
Expanding.max(*numeric_only=False* ,*engine=None* ,*engine_kwargs=None* )[source]#
- Calculate the expanding maximum. At each point in time, returns the maximum value observed up to that point, respecting the `min_periods` threshold.
  - Parameters:
