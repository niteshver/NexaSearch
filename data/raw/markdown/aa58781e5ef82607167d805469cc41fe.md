...
categories or ordered.
    ...
    - If True, validate that the codes are valid for the dtype. If False, don’t validate that the codes are valid. Be careful about skipping validation, as invalid codes can lead to severe problems, such as segfaults. New in version 2.1.0.
  - Returns:
    - Categorical
