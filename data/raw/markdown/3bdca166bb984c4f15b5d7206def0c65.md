...
a copy is made, even if not strictly necessary.
    ...
    - The value to use for missing values. The default value depends on dtype and the type of the array. New in version 1.0.0.
    - ****kwargs**
    - Additional keywords passed through to the `to_numpy` method
of the underlying array (for extension arrays).New in version 1.0.0.
  - Returns
    - numpy.ndarray
 See also 
  - `Series.array`
