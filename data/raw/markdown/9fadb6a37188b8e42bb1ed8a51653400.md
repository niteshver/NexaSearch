...
1For simplicity, we sometimes refer to it as “example(s)” throughout this paper.pend on translation references or human judgment.
...
2The question of the order of examples is not specifically discussed in this paper but is left for future work.tience threshold. Alternatively, the process termi-
...
text of a test set using our methodology are depicted in Figure 2.(since the QE data creation process requires a triplet
...
5In the literature, the term “prompt” is frequently used interchangeably with “ICE”evance and effectiveness of the prompts.
...
The script for running our experiments
...
7https://github.com/lfwa/carbontrackerMethod p+qBLEU COMET TTP CO2 GPU
(hh:mm) (kg) (kWh)
...
results indicate that fine-tuning mBART-50 leads tosuperior performance compared with lexical over-
...
8Our other models in Mode 1 exhibited similar distributions.CO 2Emissions Our analysis reveals that using
...
9Also referred to as the prompt retrieval methodBLEU and COMET metrics. Our method consis-
...
Can We Know What Language Models Know? Trans-actions of the Association for Computational Linguis-
tics, 8:423–438.
...
guistics.Post, M. (2018). A call for clarity in reporting BLEU
...
ery.Vilar, D., Freitag, M., Cherry, C., Luo, J., Ratnakar, V .,
...
QE estimation compared to the BLEU score computed based on the reference label.1:function SEARCH (...)
2: temp←[(“”,0.0,“”)]
3: prompt ←“”
4: itr←0
5: best qescore←0.0
