...
- Convert the PeriodIndex to the specified frequency freq. Equivalent to applying `pandas.Period.asfreq()` with the given arguments
to each`Period` in this PeriodIndex.
  - Parameters:
    - **freq** str
    - A frequency.
