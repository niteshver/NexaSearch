...
on the rows and columns.
    ...
    - ****kwargs** dict
    - Optional keyword arguments to pass to `aggfunc` .Added in version 3.0.0.
  - Returns:
    - DataFrame
