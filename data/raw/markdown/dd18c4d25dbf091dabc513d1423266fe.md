...
- Status: Implemented
- Discussion: #50424
- Author: Marco Gorelli (original issue by Joris Van den Bossche)
- Revision: 1
...
1. 
changing `Block.setitem` such that it does not have an`except` block in:```
