...
If False, the funcs will be passed the whole Series at once.Added in version 2.1.0.
 ...
 Note: The numba compiler only supports a subset of valid Python/numpy operations. Please read more about the supported python features and supported numpy features in numba to learn what you can or cannot use in the passed function. Added in version 2.2.0.
    - **engine_kwargs** dict
