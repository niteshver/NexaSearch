...
# 
 ![](https://huggingface.co/avatars/a355f2a11378fae43db2ae9ecf44afb3.svg) ⟨28⟩
asfafa454⟨28⟩
/
...
Copy to bucket new
Use this model
### Instructions to use asfafa454/MyAwesomeModel-TestRepo with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  * Libraries
  *  Transformers⟨36⟩
How to use asfafa454/MyAwesomeModel-TestRepo with Transformers:

```
# Use a pipeline as a high-level helper
from transformers import pipeline

pipe = pipeline("feature-extraction", model="asfafa454/MyAwesomeModel-TestRepo")
```
...
tokenizer = AutoTokenizer.from_pretrained("asfafa454/MyAwesomeModel-TestRepo")
model = AutoModel.from_pretrained("asfafa454/MyAwesomeModel-TestRepo", device_map="auto")
```
...
![MyAwesomeModel⟨51⟩]
* * *
 ![License](https://huggingface.co/asfafa454/MyAwesomeModel-TestRepo/resolve/main/figures/fig2.png) ⟨52⟩
##   ⟨40⟩ 1. Introduction 
