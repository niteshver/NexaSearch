...
| `DataFrame.iteritems` () | (DEPRECATED) Iterate over (column name, Series) pairs. | 
...
| `DataFrame.mad` ([axis, skipna, level]) | (DEPRECATED) Return the mean absolute deviation of the values over the requested axis. | 
...
| `DataFrame.rename_axis` ([mapper, inplace]) | Set the name of the axis for the index or columns. | 
...
| `DataFrame.set_axis` (labels, *[, axis, ...]) | Assign desired index to given axis. | 
...
| `DataFrame.bfill` (*[, axis, inplace, limit, ...]) | Synonym for `DataFrame.fillna()` with`method='bfill'` . | 
| `DataFrame.dropna` (*[, axis, how, thresh, ...]) | Remove missing values. | 
| `DataFrame.ffill` (*[, axis, inplace, limit, ...]) | Synonym for `DataFrame.fillna()` with`method='ffill'` . | 
...
| `DataFrame.pad` (*[, axis, inplace, limit, ...]) | Synonym for `DataFrame.fillna()` with`method='ffill'` . | 
...
| `DataFrame.append` (other[, ignore_index, ...]) | (DEPRECATED) Append rows of other to the end of caller, returning a new object. | 
