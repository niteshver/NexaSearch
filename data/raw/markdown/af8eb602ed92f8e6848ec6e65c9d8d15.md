...
# 
 ![](https://huggingface.co/avatars/84a2011291889ce00e9a9dfd2d87dd0b.svg) ⟨28⟩
A11asda⟨28⟩
/
...
Copy to bucket new
Use this model
### Instructions to use A11asda/MyAwesomeModel-TestRepo with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  * Libraries
  *  Transformers⟨36⟩
How to use A11asda/MyAwesomeModel-TestRepo with Transformers:

```
# Use a pipeline as a high-level helper
from transformers import pipeline

pipe = pipeline("feature-extraction", model="A11asda/MyAwesomeModel-TestRepo")
```
...
tokenizer = AutoTokenizer.from_pretrained("A11asda/MyAwesomeModel-TestRepo")
model = AutoModel.from_pretrained("A11asda/MyAwesomeModel-TestRepo", device_map="auto")
```
...
![MyAwesomeModel⟨51⟩]
* * *
 ![License](https://huggingface.co/A11asda/MyAwesomeModel-TestRepo/resolve/main/figures/fig2.png) ⟨52⟩
##   ⟨40⟩ 1. Introduction 
