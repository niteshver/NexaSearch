...
- 
*class* `sklearn.feature_selection.``SelectPercentile` (*score_func=<function f_classif at 0x2b80949fb578>* ,*percentile=10* )[source]¶
- Select features according to a percentile of the highest scores. Parameters: **score_func** : callableFunction taking two arrays X and y, and returning a pair of arrays (scores, pvalues). **percentile** : int, optional, default=10Percent of features to keep. Attributes: **scores_** : array-like, shape=(n_features,)Scores of features. **pvalues_** : array-like, shape=(n_features,)p-values of feature scores. See also 
  - `f_classif`
