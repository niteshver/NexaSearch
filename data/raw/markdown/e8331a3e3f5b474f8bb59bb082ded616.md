...
File ~/work/pandas/pandas/pandas/core/tools/datetimes.py:1217, in to_datetime(arg, errors, dayfirst, yearfirst, utc, format, exact, unit, origin, cache)
   1215         result = _convert_and_box_cache(argc, cache_array)
   1216     else:
-> 1217         result = convert_listlike(argc, format)
   1218 else:
   1219     result = convert_listlike(np.array([arg]), format)[0]
File ~/work/pandas/pandas/pandas/core/tools/datetimes.py:470, in _convert_listlike_datetimes(arg, format, name, utc, unit, errors, dayfirst, yearfirst, exact)
    468 # `format` could be inferred, or user didn't ask for mixed-format parsing.
    469 if format is not None and format != "mixed":
--> 470     return _array_strptime_with_fallback(arg, name, utc, format, exact, errors)
    472 result, tz_parsed = objects_to_datetime64(
    473     arg,
    474     dayfirst=dayfirst,
   (...)    478     allow_object=True,
    479 )
    481 if tz_parsed is not None:
    482     # We can take a shortcut since the datetime64 numpy array
    483     # is in UTC
File ~/work/pandas/pandas/pandas/core/tools/datetimes.py:505, in _array_strptime_with_fallback(arg, name, utc, fmt, exact, errors)
    494 def _array_strptime_with_fallback(
    495     arg,
    496     name,
   (...)    500     errors: str,
    501 ) -> Index:
    502     """
    503     Call array_strptime, with fallback behavior depending on 'errors'.
    504     """
--> 505     result, tz_out = array_strptime(arg, fmt, exact=exact, errors=errors, utc=utc)
    506     if tz_out is not None:
    507         unit = np.datetime_data(result.dtype)[0]
File pandas/_libs/tslibs/strptime.pyx:625, in pandas._libs.tslibs.strptime.array_strptime()
--> 625 'Could not get source, probably due dynamically evaluated source code.'
File pandas/_libs/tslibs/strptime.pyx:558, in pandas._libs.tslibs.strptime.array_strptime()
--> 558 'Could not get source, probably due dynamically evaluated source code.'
File pandas/_libs/tslibs/strptime.pyx:683, in pandas._libs.tslibs.strptime._parse_with_format()
--> 683 'Could not get source, probably due dynamically evaluated source code.'
...
```
In [159]: rng2 = pd.date_range("2011-01-01", "2012-01-01", freq="W")
In [160]: ts2 = pd.Series(np.random.randn(len(rng2)), index=rng2)
In [161]: ts2.truncate(before="2011-11", after="2011-12")
Out[161]: 
2011-11-06    0.437823
2011-11-13   -0.293083
2011-11-20   -0.059881
...
```
In [164]: idx = pd.date_range(start="2019-12-29", freq="D", periods=4)
In [165]: idx.isocalendar()
Out[165]: 
            year  week  day
...
2019-12-31  2020     1    2
2020-01-01  2020     1    3
In [166]: idx.to_series().dt.isocalendar()
Out[166]: 
            year  week  day
2019-12-29  2019    52    7
2019-12-30  2020     1    1
...
In [167]: ts = pd.Timestamp("2016-10-30 00:00:00", tz="Europe/Helsinki")
# Respects absolute time
In [168]: ts + pd.Timedelta(days=1)
Out[168]: Timestamp('2016-10-30 23:00:00+0200', tz='Europe/Helsinki')
# Respects calendar time
In [169]: ts + pd.DateOffset(days=1)
Out[169]: Timestamp('2016-10-31 00:00:00+0200', tz='Europe/Helsinki')
In [170]: friday = pd.Timestamp("2018-01-05")
In [171]: friday.day_name()
Out[171]: 'Friday'
# Add 2 business days (Friday --> Tuesday)
In [172]: two_business_days = 2 * pd.offsets.BDay()
In [173]: friday + two_business_days
Out[173]: Timestamp('2018-01-09 00:00:00')
In [174]: (friday + two_business_days).day_name()
Out[174]: 'Tuesday'
```
...
```
In [175]: ts = pd.Timestamp("2018-01-06 00:00:00")
In [176]: ts.day_name()
Out[176]: 'Saturday'
# BusinessHour's valid offset dates are Monday through Friday
In [177]: offset = pd.offsets.BusinessHour(start="09:00")
# Bring the date to the closest offset date (Monday)
In [178]: offset.rollforward(ts)
Out[178]: Timestamp('2018-01-08 09:00:00')
# Date is brought to the closest offset date first and then the hour is added
In [179]: ts + offset
Out[179]: Timestamp('2018-01-08 10:00:00')
```
...
```
In [180]: ts = pd.Timestamp("2014-01-01 09:00")
In [181]: day = pd.offsets.Day()
In [182]: day + ts
Out[182]: Timestamp('2014-01-02 09:00:00')
In [183]: (day + ts).normalize()
Out[183]: Timestamp('2014-01-02 00:00:00')
In [184]: ts = pd.Timestamp("2014-01-01 22:00")
In [185]: hour = pd.offsets.Hour()
In [186]: hour + ts
Out[186]: Timestamp('2014-01-01 23:00:00')
In [187]: (hour + ts).normalize()
Out[187]: Timestamp('2014-01-01 00:00:00')
In [188]: (hour + pd.Timestamp("2014-01-01 23:30")).normalize()
Out[188]: Timestamp('2014-01-02 00:00:00')
```
### Parametric offsets#
...
```
In [189]: d = datetime.datetime(2008, 8, 18, 9, 0)
In [190]: d
Out[190]: datetime.datetime(2008, 8, 18, 9, 0)
In [191]: d + pd.offsets.Week()
Out[191]: Timestamp('2008-08-25 09:00:00')
In [192]: d + pd.offsets.Week(weekday=4)
Out[192]: Timestamp('2008-08-22 09:00:00')
In [193]: (d + pd.offsets.Week(weekday=4)).weekday()
Out[193]: 4
In [194]: d - pd.offsets.Week()
Out[194]: Timestamp('2008-08-11 09:00:00')
```
The `normalize` option will be effective for addition and subtraction.

```
In [195]: d + pd.offsets.Week(normalize=True)
Out[195]: Timestamp('2008-08-25 00:00:00')
In [196]: d - pd.offsets.Week(normalize=True)
Out[196]: Timestamp('2008-08-11 00:00:00')
```
Another example is parameterizing `YearEnd` with the specific ending month:

```
In [197]: d + pd.offsets.YearEnd()
Out[197]: Timestamp('2008-12-31 09:00:00')
In [198]: d + pd.offsets.YearEnd(month=6)
Out[198]: Timestamp('2009-06-30 09:00:00')
```
...
```
In [199]: rng = pd.date_range("2012-01-01", "2012-01-03")
In [200]: s = pd.Series(rng)
In [201]: rng
Out[201]: 
DatetimeIndex(['2012-01-01', '2012-01-02', '2012-01-03'],
              dtype='datetime64[us]', freq='D')
In [202]: rng + pd.DateOffset(months=2)
Out[202]: 
DatetimeIndex(['2012-03-01', '2012-03-02', '2012-03-03'],
              dtype='datetime64[us]', freq=None)
In [203]: s + pd.DateOffset(months=2)
Out[203]: 
0   2012-03-01
1   2012-03-02
2   2012-03-03
dtype: datetime64[us]
In [204]: s - pd.DateOffset(months=2)
Out[204]: 
0   2011-11-01
1   2011-11-02
2   2011-11-03
...
```
In [205]: s - pd.offsets.Day(2)
Out[205]: 
0   2011-12-30
1   2011-12-31
2   2012-01-01
dtype: datetime64[us]
In [206]: td = s - pd.Series(pd.date_range("2011-12-29", "2011-12-31"))
In [207]: td
Out[207]: 
0   3 days
1   3 days
...
In [208]: td + pd.offsets.Minute(15)
Out[208]: 
0   3 days 00:15:00
1   3 days 00:15:00
2   3 days 00:15:00
...
```
In [209]: rng + pd.offsets.BQuarterEnd()
Out[209]: 
...
```
In [210]: weekmask_egypt = "Sun Mon Tue Wed Thu"
...
In [211]: holidays = [
   ...
   .....: ]
   .....: 
In [212]: bday_egypt = pd.offsets.CustomBusinessDay(
   .....:     holidays=holidays,
   .....:     weekmask=weekmask_egypt,
   .....: )
   .....: 
In [213]: dt = datetime.datetime(2013, 4, 30)
In [214]: dt + 2 * bday_egypt
Out[214]: Timestamp('2013-05-05 00:00:00')
```
Let’s map to the weekday names:

```
In [215]: dts = pd.date_range(dt, periods=5, freq=bday_egypt)
In [216]: pd.Series(dts.day_of_week, dts).map(pd.Series("Mon Tue Wed Thu Fri Sat Sun".split()))
Out[216]: 
2013-04-30    Tue
2013-05-02    Thu
2013-05-05    Sun
...
```
In [217]: from pandas.tseries.holiday import USFederalHolidayCalendar
In [218]: bday_us = pd.offsets.CustomBusinessDay(calendar=USFederalHolidayCalendar())
# Friday before MLK Day
In [219]: dt = datetime.datetime(2014, 1, 17)
# Tuesday after MLK Day (Monday is skipped because it's a holiday)
In [220]: dt + bday_us
Out[220]: Timestamp('2014-01-21 00:00:00')
```
Monthly offsets that respect a certain holiday calendar can be defined in the usual way.

```
In [221]: bmth_us = pd.offsets.CustomBusinessMonthBegin(calendar=USFederalHolidayCalendar())
# Skip new years
In [222]: dt = datetime.datetime(2013, 12, 17)
In [223]: dt + bmth_us
Out[223]: Timestamp('2014-01-02 00:00:00')
# Define date index with custom offset
In [224]: pd.date_range(start="20100101", end="20120101", freq=bmth_us)
Out[224]: 
...
```
In [225]: bh = pd.offsets.BusinessHour()
In [226]: bh
Out[226]: <BusinessHour: bh=09:00-17:00>
# 2014-08-01 is Friday
In [227]: pd.Timestamp("2014-08-01 10:00").weekday()
Out[227]: 4
In [228]: pd.Timestamp("2014-08-01 10:00") + bh
Out[228]: Timestamp('2014-08-01 11:00:00')
# Below example is the same as: pd.Timestamp('2014-08-01 09:00') + bh
In [229]: pd.Timestamp("2014-08-01 08:00") + bh
Out[229]: Timestamp('2014-08-01 10:00:00')
# If the results is on the end time, move to the next business day
In [230]: pd.Timestamp("2014-08-01 16:00") + bh
Out[230]: Timestamp('2014-08-04 09:00:00')
# Remainings are added to the next day
In [231]: pd.Timestamp("2014-08-01 16:30") + bh
Out[231]: Timestamp('2014-08-04 09:30:00')
# Adding 2 business hours
In [232]: pd.Timestamp("2014-08-01 10:00") + pd.offsets.BusinessHour(2)
Out[232]: Timestamp('2014-08-01 12:00:00')
# Subtracting 3 business hours
In [233]: pd.Timestamp("2014-08-01 10:00") + pd.offsets.BusinessHour(-3)
Out[233]: Timestamp('2014-07-31 15:00:00')
```
...
```
In [234]: bh = pd.offsets.BusinessHour(start="11:00", end=datetime.time(20, 0))
In [235]: bh
Out[235]: <BusinessHour: bh=11:00-20:00>
In [236]: pd.Timestamp("2014-08-01 13:00") + bh
Out[236]: Timestamp('2014-08-01 14:00:00')
In [237]: pd.Timestamp("2014-08-01 09:00") + bh
Out[237]: Timestamp('2014-08-01 12:00:00')
In [238]: pd.Timestamp("2014-08-01 18:00") + bh
Out[238]: Timestamp('2014-08-01 19:00:00')
```
...
```
In [239]: bh = pd.offsets.BusinessHour(start="17:00", end="09:00")
In [240]: bh
Out[240]: <BusinessHour: bh=17:00-09:00>
In [241]: pd.Timestamp("2014-08-01 17:00") + bh
Out[241]: Timestamp('2014-08-01 18:00:00')
In [242]: pd.Timestamp("2014-08-01 23:00") + bh
Out[242]: Timestamp('2014-08-02 00:00:00')
# Although 2014-08-02 is Saturday,
# it is valid because it starts from 08-01 (Friday).
In [243]: pd.Timestamp("2014-08-02 04:00") + bh
Out[243]: Timestamp('2014-08-02 05:00:00')
# Although 2014-08-04 is Monday,
# it is out of business hours because it starts from 08-03 (Sunday).
In [244]: pd.Timestamp("2014-08-04 04:00") + bh
Out[244]: Timestamp('2014-08-04 18:00:00')
```
...
In [245]: pd.offsets.BusinessHour().rollback(pd.Timestamp("2014-08-02 15:00"))
Out[245]: Timestamp('2014-08-01 17:00:00')
In [246]: pd.offsets.BusinessHour().rollforward(pd.Timestamp("2014-08-02 15:00"))
Out[246]: Timestamp('2014-08-04 09:00:00')
# It is the same as BusinessHour() + pd.Timestamp('2014-08-01 17:00').
# And it is the same as BusinessHour() + pd.Timestamp('2014-08-04 09:00')
In [247]: pd.offsets.BusinessHour() + pd.Timestamp("2014-08-02 15:00")
Out[247]: Timestamp('2014-08-04 10:00:00')
# BusinessDay results (for reference)
In [248]: pd.offsets.BusinessHour().rollforward(pd.Timestamp("2014-08-02"))
Out[248]: Timestamp('2014-08-04 09:00:00')
# It is the same as BusinessDay() + pd.Timestamp('2014-08-01')
# The result is the same as rollworward because BusinessDay never overlap.
In [249]: pd.offsets.BusinessHour() + pd.Timestamp("2014-08-02")
Out[249]: Timestamp('2014-08-04 10:00:00')
```
...
```
In [250]: from pandas.tseries.holiday import USFederalHolidayCalendar
In [251]: bhour_us = pd.offsets.CustomBusinessHour(calendar=USFederalHolidayCalendar())
# Friday before MLK Day
In [252]: dt = datetime.datetime(2014, 1, 17, 15)
In [253]: dt + bhour_us
Out[253]: Timestamp('2014-01-17 16:00:00')
# Tuesday after MLK Day (Monday is skipped because it's a holiday)
In [254]: dt + bhour_us * 2
Out[254]: Timestamp('2014-01-21 09:00:00')
```
You can use keyword arguments supported by either `BusinessHour` and `CustomBusinessDay`.

```
In [255]: bhour_mon = pd.offsets.CustomBusinessHour(start="10:00", weekmask="Tue Wed Thu Fri")
# Monday is skipped because it's a holiday, business hour starts from 10:00
In [256]: dt + bhour_mon * 2
Out[256]: Timestamp('2014-01-21 10:00:00')
```
### Offset aliases#
...
```
In [257]: dates_lst_1 = pd.date_range("2020-01-06", "2020-04-03", freq="MS")
In [258]: dates_lst_1
Out[258]: 
DatetimeIndex(['2020-02-01', '2020-03-01', '2020-04-01'],
              dtype='datetime64[us]', freq='MS')
In [259]: dates_lst_2 = pd.date_range("2020-01-01", "2020-04-01", freq="MS")
In [260]: dates_lst_2
Out[260]: 
...
```
In [261]: pd.date_range(start, periods=5, freq="B")
Out[261]: 
DatetimeIndex(['2011-01-03', '2011-01-04', '2011-01-05', '2011-01-06',
               '2011-01-07'],
              dtype='datetime64[us]', freq='B')
In [262]: pd.date_range(start, periods=5, freq=pd.offsets.BDay())
Out[262]: 
DatetimeIndex(['2011-01-03', '2011-01-04', '2011-01-05', '2011-01-06',
               '2011-01-07'],
              dtype='datetime64[us]', freq='B')
...
```
In [263]: pd.date_range(start, periods=10, freq="2h20min")
Out[263]: 
...
In [264]: pd.date_range(start, periods=10, freq="1D10us")
Out[264]: 
...
```
In [265]: pd.Timestamp("2014-01-02") + pd.offsets.MonthBegin(n=1)
Out[265]: Timestamp('2014-02-01 00:00:00')
In [266]: pd.Timestamp("2014-01-02") + pd.offsets.MonthEnd(n=1)
Out[266]: Timestamp('2014-01-31 00:00:00')
In [267]: pd.Timestamp("2014-01-02") - pd.offsets.MonthBegin(n=1)
Out[267]: Timestamp('2014-01-01 00:00:00')
In [268]: pd.Timestamp("2014-01-02") - pd.offsets.MonthEnd(n=1)
Out[268]: Timestamp('2013-12-31 00:00:00')
In [269]: pd.Timestamp("2014-01-02") + pd.offsets.MonthBegin(n=4)
Out[269]: Timestamp('2014-05-01 00:00:00')
In [270]: pd.Timestamp("2014-01-02") - pd.offsets.MonthBegin(n=4)
Out[270]: Timestamp('2013-10-01 00:00:00')
```
If the given date *is* on an anchor point, it is moved `|n|` points forwards
or backwards.

```
In [271]: pd.Timestamp("2014-01-01") + pd.offsets.MonthBegin(n=1)
Out[271]: Timestamp('2014-02-01 00:00:00')
In [272]: pd.Timestamp("2014-01-31") + pd.offsets.MonthEnd(n=1)
Out[272]: Timestamp('2014-02-28 00:00:00')
In [273]: pd.Timestamp("2014-01-01") - pd.offsets.MonthBegin(n=1)
Out[273]: Timestamp('2013-12-01 00:00:00')
In [274]: pd.Timestamp("2014-01-31") - pd.offsets.MonthEnd(n=1)
Out[274]: Timestamp('2013-12-31 00:00:00')
In [275]: pd.Timestamp("2014-01-01") + pd.offsets.MonthBegin(n=4)
Out[275]: Timestamp('2014-05-01 00:00:00')
In [276]: pd.Timestamp("2014-01-31") - pd.offsets.MonthBegin(n=4)
Out[276]: Timestamp('2013-10-01 00:00:00')
```
For the case when `n=0`, the date is not moved if on an anchor point, otherwise
it is rolled forward to the next anchor point.

```
In [277]: pd.Timestamp("2014-01-02") + pd.offsets.MonthBegin(n=0)
Out[277]: Timestamp('2014-02-01 00:00:00')
In [278]: pd.Timestamp("2014-01-02") + pd.offsets.MonthEnd(n=0)
Out[278]: Timestamp('2014-01-31 00:00:00')
In [279]: pd.Timestamp("2014-01-01") + pd.offsets.MonthBegin(n=0)
Out[279]: Timestamp('2014-01-01 00:00:00')
In [280]: pd.Timestamp("2014-01-31") + pd.offsets.MonthEnd(n=0)
Out[280]: Timestamp('2014-01-31 00:00:00')
```
...
```
In [281]: from pandas.tseries.holiday import (
   .....:     Holiday,
   .....:     USMemorialDay,
   ...
   .....: )
   .....: 
In [282]: class ExampleCalendar(AbstractHolidayCalendar):
   .....:     rules = [
   .....:         USMemorialDay,
   ...
   .....:     ]
   .....: 
In [283]: cal = ExampleCalendar()
In [284]: cal.holidays(datetime.datetime(2012, 1, 1), datetime.datetime(2012, 12, 31))
Out[284]: 
...
In [286]: offset = pd.offsets.CustomBusinessDay(calendar=cal)
In [287]: datetime.datetime(2012, 5, 25) + offset
Out[287]: Timestamp('2012-05-29 00:00:00')
In [288]: datetime.datetime(2012, 7, 3) + offset
Out[288]: Timestamp('2012-07-05 00:00:00')
In [289]: datetime.datetime(2012, 7, 3) + 2 * offset
Out[289]: Timestamp('2012-07-06 00:00:00')
In [290]: datetime.datetime(2012, 7, 6) + offset
Out[290]: Timestamp('2012-07-09 00:00:00')
```
...
```
In [291]: AbstractHolidayCalendar.start_date
Out[291]: Timestamp('1970-01-01 00:00:00')
In [292]: AbstractHolidayCalendar.end_date
Out[292]: Timestamp('2200-12-31 00:00:00')
```
These dates can be overwritten by setting the attributes as datetime/Timestamp/string.

```
In [293]: AbstractHolidayCalendar.start_date = datetime.datetime(2012, 1, 1)
In [294]: AbstractHolidayCalendar.end_date = datetime.datetime(2012, 12, 31)
In [295]: cal.holidays()
Out[295]: 
DatetimeIndex(['2012-05-28', '2012-07-04', '2012-10-08'],
              dtype='datetime64[us]', freq=None)
...
```
In [296]: from pandas.tseries.holiday import get_calendar, HolidayCalendarFactory, USLaborDay
In [297]: cal = get_calendar("ExampleCalendar")
In [298]: cal.rules
Out[298]: 
[Holiday: Memorial Day (month=5, day=31, offset=<DateOffset: weekday=MO(-1)>),
 Holiday: July 4th (month=7, day=4, observance=<function nearest_workday at 0x7f9b333dccc0>),
 Holiday: Columbus Day (month=10, day=1, offset=<DateOffset: weekday=MO(+2)>)]
In [299]: new_cal = HolidayCalendarFactory("NewExampleCalendar", cal, USLaborDay)
In [300]: new_cal.rules
Out[300]: 
...
```
In [312]: rng = pd.date_range("1/1/2012", periods=100, freq="s")
In [313]: ts = pd.Series(np.random.randint(0, 500, len(rng)), index=rng)
In [314]: ts.resample("5Min").sum()
Out[314]: 
2012-01-01    25103
...
```
In [315]: ts.resample("5Min").mean()
Out[315]: 
2012-01-01    251.03
Freq: 5min, dtype: float64
In [316]: ts.resample("5Min").ohlc()
Out[316]: 
            open  high  low  close
2012-01-01   308   460    9    205
In [317]: ts.resample("5Min").max()
Out[317]: 
2012-01-01    460
Freq: 5min, dtype: int64
```
...
```
In [318]: ts.resample("5Min", closed="right").mean()
Out[318]: 
2011-12-31 23:55:00    308.000000
2012-01-01 00:00:00    250.454545
Freq: 5min, dtype: float64
In [319]: ts.resample("5Min", closed="left").mean()
Out[319]: 
2012-01-01    251.03
Freq: 5min, dtype: float64
```
...
```
In [320]: ts.resample("5Min").mean()  # by default label='left'
Out[320]: 
2012-01-01    251.03
Freq: 5min, dtype: float64
In [321]: ts.resample("5Min", label="left").mean()
Out[321]: 
2012-01-01    251.03
Freq: 5min, dtype: float64
```
...
```
In [322]: s = pd.date_range("2000-01-01", "2000-01-05").to_series()
In [323]: s.iloc[2] = pd.NaT
In [324]: s.dt.day_name()
Out[324]: 
2000-01-01     Saturday
2000-01-02       Sunday
2000-01-03          NaN
...
In [325]: s.resample("B").last().dt.day_name()
Out[325]: 
1999-12-31       Sunday
2000-01-03          NaN
2000-01-04      Tuesday
...
```
In [326]: s.resample("B", label="right", closed="right").last().dt.day_name()
Out[326]: 
2000-01-03       Sunday
2000-01-04      Tuesday
2000-01-05    Wednesday
...
In [327]: ts[:2].resample("250ms").asfreq()
Out[327]: 
...
In [328]: ts[:2].resample("250ms").ffill()
Out[328]: 
...
In [329]: ts[:2].resample("250ms").ffill(limit=2)
Out[329]: 
2012-01-01 00:00:00.000    308.0
...
```
In [330]: rng = pd.date_range("2014-1-1", periods=100, freq="D") + pd.Timedelta("1s")
In [331]: ts = pd.Series(range(100), index=rng)
```
If we want to resample to the full range of the series:

```
In [332]: ts.resample("3min").sum()
Out[332]: 
...
```
In [333]: from functools import partial
In [334]: from pandas.tseries.frequencies import to_offset
In [335]: def round(t, freq):
   .....:     freq = to_offset(freq)
   .....:     td = pd.Timedelta(freq)
   .....:     return pd.Timestamp((t.value // td.value) * td.value)
   .....: 
In [336]: ts.groupby(partial(round, freq="3min")).sum()
Out[336]: 
2014-01-01     0
2014-01-02     1
2014-01-03     2
...
```
In [337]: df = pd.DataFrame(
   .....:     np.random.randn(1000, 3),
   .....:     index=pd.date_range("1/1/2012", freq="s", periods=1000),
   .....:     columns=["A", "B", "C"],
   .....: )
   .....: 
In [338]: r = df.resample("3min")
In [339]: r.mean()
Out[339]: 
                            A         B         C
...
```
In [344]: r.agg({"A": "sum", "B": lambda x: np.std(x, ddof=1)})
Out[344]: 
                             A         B
...
```
In [346]: r.agg({"A": ["sum", "std"], "B": ["mean", "std"]})
Out[346]: 
                             A                   B          
                           sum       std      mean       std
...
In [349]: df.resample("MS", on="date")[["a"]].sum()
Out[349]: 
            a
date         
2015-01-01  6
...
```
In [350]: df.resample("MS", level="d")[["a"]].sum()
Out[350]: 
            a
d            
2015-01-01  6
...
In [351]: small = pd.Series(
   ...
   .....: )
   .....: 
In [352]: resampled = small.resample("h")
In [353]: for name, group in resampled:
   .....:     print("Group: ", name)
   .....:     print("-" * 27)
   .....:     print(group, end="\n\n")
   .....: 
...
```
In [354]: start, end = "2000-10-01 23:30:00", "2000-10-02 00:30:00"
In [355]: middle = "2000-10-02 00:00:00"
In [356]: rng = pd.date_range(start, end, freq="7min")
In [357]: ts = pd.Series(np.arange(len(rng)) * 3, index=rng)
In [358]: ts
Out[358]: 
...
```
In [359]: ts.resample("17min", origin="start_day").sum()
Out[359]: 
...
In [360]: ts[middle:end].resample("17min", origin="start_day").sum()
Out[360]: 
...
```
In [361]: ts.resample("17min", origin="epoch").sum()
Out[361]: 
...
2000-10-02 00:26:00    24
Freq: 17min, dtype: int64
In [362]: ts[middle:end].resample("17min", origin="epoch").sum()
Out[362]: 
...
```
In [363]: ts.resample("17min", origin="2001-01-01").sum()
Out[363]: 
...
Freq: 17min, dtype: int64
In [364]: ts[middle:end].resample("17min", origin=pd.Timestamp("2001-01-01")).sum()
Out[364]: 
2000-10-02 00:04:00    54
2000-10-02 00:21:00    24
Freq: 17min, dtype: int64
...
```
In [365]: ts.resample("17min", origin="start").sum()
Out[365]: 
2000-10-01 23:30:00     9
2000-10-01 23:47:00    21
2000-10-02 00:04:00    54
2000-10-02 00:21:00    24
Freq: 17min, dtype: int64
In [366]: ts.resample("17min", offset="23h30min").sum()
Out[366]: 
2000-10-01 23:30:00     9
2000-10-01 23:47:00    21
2000-10-02 00:04:00    54
...
```
In [367]: ts.resample('17min', origin='end').sum()
Out[367]: 
...
```
In [368]: ts.resample('17min', origin='end_day').sum()
Out[368]: 
...
```
In [369]: ceil_mid = rng.max().ceil('D')
In [370]: freq = pd.offsets.Minute(17)
In [371]: bin_res = ceil_mid - freq * ((ceil_mid - rng.max()) // freq)
In [372]: bin_res
Out[372]: Timestamp('2000-10-02 00:29:00')
```
...
```
In [373]: pd.Period("2012", freq="Y-DEC")
Out[373]: Period('2012', 'Y-DEC')
In [374]: pd.Period("2012-1-1", freq="D")
Out[374]: Period('2012-01-01', 'D')
In [375]: pd.Period("2012-1-1 19:00", freq="h")
Out[375]: Period('2012-01-01 19:00', 'h')
In [376]: pd.Period("2012-1-1 19:00", freq="5h")
Out[376]: Period('2012-01-01 19:00', '5h')
```
...
```
In [377]: p = pd.Period("2012", freq="Y-DEC")
In [378]: p + 1
Out[378]: Period('2013', 'Y-DEC')
In [379]: p - 3
Out[379]: Period('2009', 'Y-DEC')
In [380]: p = pd.Period("2012-01", freq="2M")
In [381]: p + 2
Out[381]: Period('2012-05', '2M')
In [382]: p - 1
Out[382]: Period('2011-11', '2M')
In [383]: p == pd.Period("2012-01", freq="3M")
Out[383]: False
```
...
```
In [384]: p = pd.Period("2014-07-01 09:00", freq="h")
In [385]: p + pd.offsets.Hour(2)
Out[385]: Period('2014-07-01 11:00', 'h')
In [386]: p + datetime.timedelta(minutes=120)
Out[386]: Period('2014-07-01 11:00', 'h')
In [387]: p + np.timedelta64(7200, "s")
Out[387]: Period('2014-07-01 11:00', 'h')
```
```
In [388]: p + pd.offsets.Minute(5)
---------------------------------------------------------------------------
ValueError                                Traceback (most recent call last)
File pandas/_libs/tslibs/period.pyx:2079, in pandas._libs.tslibs.period._Period._add_timedeltalike_scalar()
-> 2079 'Could not get source, probably due dynamically evaluated source code.'
File pandas/_libs/tslibs/timedeltas.pyx:290, in pandas._libs.tslibs.timedeltas.delta_to_nanoseconds()
--> 290 'Could not get source, probably due dynamically evaluated source code.'
File pandas/_libs/tslibs/np_datetime.pyx:762, in pandas._libs.tslibs.np_datetime.convert_reso()
--> 762 'Could not get source, probably due dynamically evaluated source code.'
ValueError: Cannot losslessly convert units
The above exception was the direct cause of the following exception:
IncompatibleFrequency                     Traceback (most recent call last)
Cell In[388], line 1
----> 1 p + pd.offsets.Minute(5)
File pandas/_libs/tslibs/period.pyx:2100, in pandas._libs.tslibs.period._Period.__add__()
-> 2100 'Could not get source, probably due dynamically evaluated source code.'
File pandas/_libs/tslibs/period.pyx:2081, in pandas._libs.tslibs.period._Period._add_timedeltalike_scalar()
-> 2081 'Could not get source, probably due dynamically evaluated source code.'
...
```
In [389]: p = pd.Period("2014-07", freq="M")
In [390]: p + pd.offsets.MonthEnd(3)
Out[390]: Period('2014-10', 'M')
```
```
In [391]: p + pd.offsets.MonthBegin(3)
---------------------------------------------------------------------------
IncompatibleFrequency                     Traceback (most recent call last)
Cell In[391], line 1
----> 1 p + pd.offsets.MonthBegin(3)
File pandas/_libs/tslibs/period.pyx:2102, in pandas._libs.tslibs.period._Period.__add__()
-> 2102 'Could not get source, probably due dynamically evaluated source code.'
File pandas/_libs/tslibs/period.pyx:2092, in pandas._libs.tslibs.period._Period._add_offset()
-> 2092 'Could not get source, probably due dynamically evaluated source code.'
File pandas/_libs/tslibs/period.pyx:1898, in pandas._libs.tslibs.period.PeriodMixin._require_matching_unit()
-> 1898 'Could not get source, probably due dynamically evaluated source code.'
...
```
In [392]: pd.Period("2012", freq="Y-DEC") - pd.Period("2002", freq="Y-DEC")
Out[392]: <10 * YearEnds: month=12>
```
...
```
In [393]: prng = pd.period_range("1/1/2011", "1/1/2012", freq="M")
In [394]: prng
Out[394]: 
...
```
In [395]: pd.PeriodIndex(["2011-1", "2011-2", "2011-3"], freq="M")
Out[395]: PeriodIndex(['2011-01', '2011-02', '2011-03'], dtype='period[M]')
```
Passing multiplied frequency outputs a sequence of `Period` which
has multiplied span.

```
In [396]: pd.period_range(start="2014-01", freq="3M", periods=4)
Out[396]: PeriodIndex(['2014-01', '2014-04', '2014-07', '2014-10'], dtype='period[3M]')
```
...
```
In [397]: pd.period_range(
   .....:     start=pd.Period("2017Q1", freq="Q"), end=pd.Period("2017Q2", freq="Q"), freq="M"
   .....: )
   .....: 
Out[397]: PeriodIndex(['2017-03', '2017-04', '2017-05', '2017-06'], dtype='period[M]')
```
Just like `DatetimeIndex`, a `PeriodIndex` can also be used to index pandas
objects:

```
In [398]: ps = pd.Series(np.random.randn(len(prng)), prng)
In [399]: ps
Out[399]: 
2011-01   -2.916901
2011-02    0.514474
...
```
In [400]: idx = pd.period_range("2014-07-01 09:00", periods=5, freq="h")
In [401]: idx
Out[401]: 
PeriodIndex(['2014-07-01 09:00', '2014-07-01 10:00', '2014-07-01 11:00',
             '2014-07-01 12:00', '2014-07-01 13:00'],
            dtype='period[h]')
In [402]: idx + pd.offsets.Hour(2)
Out[402]: 
PeriodIndex(['2014-07-01 11:00', '2014-07-01 12:00', '2014-07-01 13:00',
             '2014-07-01 14:00', '2014-07-01 15:00'],
            dtype='period[h]')
In [403]: idx = pd.period_range("2014-07", periods=5, freq="M")
In [404]: idx
Out[404]: 
PeriodIndex(['2014-07', '2014-08', '2014-09', '2014-10', '2014-11'],
            dtype='period[M]')
In [405]: idx + pd.offsets.MonthEnd(3)
Out[405]: 
...
```
In [406]: pi = pd.period_range("2016-01-01", periods=3, freq="M")
In [407]: pi
Out[407]: PeriodIndex(['2016-01', '2016-02', '2016-03'], dtype='period[M]')
In [408]: pi.dtype
Out[408]: period[M]
```
...
In [409]: pi.astype("period[D]")
Out[409]: PeriodIndex(['2016-01-31', '2016-02-29', '2016-03-31'], dtype='period[D]')
# convert to DatetimeIndex
In [410]: pi.astype("datetime64[ns]")
Out[410]: 
DatetimeIndex(['2016-01-01', '2016-02-01', '2016-03-01'],
              dtype='datetime64[ns]', freq=None)
# convert to PeriodIndex
In [411]: dti = pd.date_range("2011-01-01", freq="ME", periods=3)
In [412]: dti
Out[412]: 
DatetimeIndex(['2011-01-31', '2011-02-28', '2011-03-31'],
              dtype='datetime64[us]', freq='ME')
In [413]: dti.astype("period[M]")
Out[413]: PeriodIndex(['2011-01', '2011-02', '2011-03'], dtype='period[M]')
```
...
```
In [414]: ps["2011-01"]
Out[414]: np.float64(-2.9169013294054507)
In [415]: ps[datetime.datetime(2011, 12, 25):]
Out[415]: 
2011-12    2.261385
2012-01   -0.329583
Freq: M, dtype: float64
In [416]: ps["10/31/2011":"12/31/2011"]
Out[416]: 
2011-10    0.056780
2011-11    0.197035
2011-12    2.261385
...
```
In [421]: dfp["2013-01-01 10h":"2013-01-01 11h"]
Out[421]: 
                         A
2013-01-01 10:00 -0.308975
2013-01-01 10:01  0.542520
...
```
In [422]: p = pd.Period("2011", freq="Y-DEC")
In [423]: p
Out[423]: Period('2011', 'Y-DEC')
```
...
```
In [424]: p.asfreq("M", how="start")
Out[424]: Period('2011-01', 'M')
In [425]: p.asfreq("M", how="end")
Out[425]: Period('2011-12', 'M')
```
The shorthands ‘s’ and ‘e’ are provided for convenience:

```
In [426]: p.asfreq("M", "s")
Out[426]: Period('2011-01', 'M')
In [427]: p.asfreq("M", "e")
Out[427]: Period('2011-12', 'M')
```
...
```
In [428]: p = pd.Period("2011-12", freq="M")
In [429]: p.asfreq("Y-NOV")
Out[429]: Period('2012', 'Y-NOV')
```
...
```
In [430]: p = pd.Period("2012Q1", freq="Q-DEC")
In [431]: p.asfreq("D", "s")
Out[431]: Period('2012-01-01', 'D')
In [432]: p.asfreq("D", "e")
Out[432]: Period('2012-03-31', 'D')
```
`Q-MAR` defines fiscal year end in March:

```
In [433]: p = pd.Period("2011Q4", freq="Q-MAR")
In [434]: p.asfreq("D", "s")
Out[434]: Period('2011-01-01', 'D')
In [435]: p.asfreq("D", "e")
Out[435]: Period('2011-03-31', 'D')
```
...
```
In [436]: rng = pd.date_range("1/1/2012", periods=5, freq="ME")
In [437]: ts = pd.Series(np.random.randn(len(rng)), index=rng)
In [438]: ts
Out[438]: 
2012-01-31    1.931253
2012-02-29   -0.184594
...
```
In [442]: ps.to_timestamp("D", how="s")
Out[442]: 
2012-01-01    1.931253
2012-02-01   -0.184594
2012-03-01    0.249656
...
```
In [443]: prng = pd.period_range("1990Q1", "2000Q4", freq="Q-NOV")
In [444]: ts = pd.Series(np.random.randn(len(prng)), prng)
In [445]: ts.index = (prng.asfreq("M", "e") + 1).asfreq("h", "s") + 9
In [446]: ts.head()
Out[446]: 
...
```
In [447]: span = pd.period_range("1215-01-01", "1381-01-01", freq="D")
In [448]: span
Out[448]: 
...
```
In [449]: s = pd.Series([20121231, 20141130, 99991231])
In [450]: s
Out[450]: 
0    20121231
1    20141130
...
2    9999-12-31
dtype: period[D]
In [453]: s.apply(conv)[2]
Out[453]: Period('9999-12-31', 'D')
```
These can easily be converted to a `PeriodIndex`:

```
In [454]: span = pd.PeriodIndex(s.apply(conv))
In [455]: span
Out[455]: PeriodIndex(['2012-12-31', '2014-11-30', '9999-12-31'], dtype='period[D]')
```
## Time zone handling#
...
```
In [456]: rng = pd.date_range("3/6/2012 00:00", periods=15, freq="D")
In [457]: rng.tz is None
Out[457]: True
```
...
```
In [458]: import dateutil
In [459]: from zoneinfo import ZoneInfo
# zoneinfo (default when using Olson strings)
In [460]: rng_zi = pd.date_range("3/6/2012 00:00", periods=3, freq="D", tz="Europe/London")
In [461]: rng_zi.tz
Out[461]: zoneinfo.ZoneInfo(key='Europe/London')
# dateutil
In [462]: rng_dateutil = pd.date_range("3/6/2012 00:00", periods=3, freq="D")
In [463]: rng_dateutil = rng_dateutil.tz_localize("dateutil/Europe/London")
In [464]: rng_dateutil.tz
Out[464]: tzfile('/usr/share/zoneinfo/Europe/London')
# dateutil - utc special case
In [465]: rng_utc = pd.date_range(
   .....:     "3/6/2012 00:00",
   .....:     periods=3,
   .....:     freq="D",
...
```
# zoneinfo
In [469]: tz_zi = ZoneInfo("Europe/London")
In [470]: rng_zi = pd.date_range("3/6/2012 00:00", periods=3, freq="D")
In [471]: rng_zi = rng_zi.tz_localize(tz_zi)
In [472]: rng_zi.tz == tz_zi
Out[472]: True
# dateutil
In [473]: tz_dateutil = dateutil.tz.gettz("Europe/London")
In [474]: rng_dateutil = pd.date_range("3/6/2012 00:00", periods=3, freq="D", tz=tz_dateutil)
In [475]: rng_dateutil.tz == tz_dateutil
Out[475]: True
```
...
```
In [476]: rng_zi.tz_convert("US/Eastern")
Out[476]: 
...
```
In [477]: rng_eastern = rng_utc.tz_convert("US/Eastern")
In [478]: rng_berlin = rng_utc.tz_convert("Europe/Berlin")
In [479]: rng_eastern[2]
Out[479]: Timestamp('2012-03-07 19:00:00-0500', tz='US/Eastern')
In [480]: rng_berlin[2]
Out[480]: Timestamp('2012-03-08 01:00:00+0100', tz='Europe/Berlin')
In [481]: rng_eastern[2] == rng_berlin[2]
Out[481]: True
```
...
```
In [482]: ts_utc = pd.Series(range(3), pd.date_range("20130101", periods=3, tz="UTC"))
In [483]: eastern = ts_utc.tz_convert("US/Eastern")
In [484]: berlin = ts_utc.tz_convert("Europe/Berlin")
In [485]: result = eastern + berlin
In [486]: result
Out[486]: 
...
```
In [488]: didx = pd.date_range(start="2014-08-01 09:00", freq="h", periods=3, tz="US/Eastern")
In [489]: didx
Out[489]: 
DatetimeIndex(['2014-08-01 09:00:00-04:00', '2014-08-01 10:00:00-04:00',
               '2014-08-01 11:00:00-04:00'],
              dtype='datetime64[us, US/Eastern]', freq='h')
In [490]: didx.tz_localize(None)
Out[490]: 
DatetimeIndex(['2014-08-01 09:00:00', '2014-08-01 10:00:00',
               '2014-08-01 11:00:00'],
              dtype='datetime64[us]', freq=None)
In [491]: didx.tz_convert(None)
Out[491]: 
DatetimeIndex(['2014-08-01 13:00:00', '2014-08-01 14:00:00',
               '2014-08-01 15:00:00'],
              dtype='datetime64[us]', freq='h')
# tz_convert(None) is identical to tz_convert('UTC').tz_localize(None)
In [492]: didx.tz_convert("UTC").tz_localize(None)
Out[492]: 
DatetimeIndex(['2014-08-01 13:00:00', '2014-08-01 14:00:00',
               '2014-08-01 15:00:00'],
              dtype='datetime64[us]', freq=None)
...
In [493]: pd.Timestamp(
   ...
   .....: )
   .....: 
Out[493]: Timestamp('2019-10-27 01:30:00+0100', tz='dateutil//usr/share/zoneinfo/Europe/London')
In [494]: pd.Timestamp(
   .....:     year=2019,
   .....:     month=10,
   .....:     day=27,
   ...
   .....: )
   .....: 
Out[494]: Timestamp('2019-10-27 01:30:00+0000', tz='dateutil//usr/share/zoneinfo/Europe/London')
```
...
```
In [495]: rng_hourly = pd.DatetimeIndex(
...
```
In [496]: rng_hourly.tz_localize('US/Eastern')
---------------------------------------------------------------------------
ValueError                                Traceback (most recent call last)
Cell In[496], line 1
----> 1 rng_hourly.tz_localize('US/Eastern')
File ~/work/pandas/pandas/pandas/core/indexes/datetimes.py:734, in DatetimeIndex.tz_localize(self, tz, ambiguous, nonexistent)
    592 """
    593 Localize tz-naive Datetime Array/Index to tz-aware Datetime Array/Index.
    594 
   (...)    731 dtype: datetime64[ns, Europe/Warsaw]
    732 """  # noqa: E501
    733 freq = self._freq
--> 734 arr = self._data.tz_localize(tz, ambiguous, nonexistent)
    735 result = type(self)._simple_new(arr, name=self.name)
    736 if timezones.is_utc(arr.tz) or (len(arr) == 1 and arr[0] is not NaT):
    737     # we can preserve freq
    738     # TODO: Also for fixed-offsets
...
File ~/work/pandas/pandas/pandas/core/arrays/datetimes.py:1117, in DatetimeArray.tz_localize(self, tz, ambiguous, nonexistent)
   1114     tz = timezones.maybe_get_tz(tz)
   1115     # Convert to UTC
-> 1117     new_dates = tzconversion.tz_localize_to_utc(
   1118         self.asi8,
   1119         tz,
   1120         ambiguous=ambiguous,
   1121         nonexistent=nonexistent,
   1122         creso=self._creso,
   1123     )
   1124 new_dates_dt64 = new_dates.view(f"M8[{self.unit}]")
   1125 dtype = tz_to_dtype(tz, unit=self.unit)
File pandas/_libs/tslibs/tzconversion.pyx:404, in pandas._libs.tslibs.tzconversion.tz_localize_to_utc()
--> 404 'Could not get source, probably due dynamically evaluated source code.'
...
```
In [497]: rng_hourly.tz_localize("US/Eastern", ambiguous="infer")
Out[497]: 
DatetimeIndex(['2011-11-06 00:00:00-04:00', '2011-11-06 01:00:00-04:00',
               '2011-11-06 01:00:00-05:00', '2011-11-06 02:00:00-05:00'],
              dtype='datetime64[us, US/Eastern]', freq=None)
In [498]: rng_hourly.tz_localize("US/Eastern", ambiguous="NaT")
Out[498]: 
DatetimeIndex(['2011-11-06 00:00:00-04:00', 'NaT', 'NaT',
               '2011-11-06 02:00:00-05:00'],
              dtype='datetime64[us, US/Eastern]', freq=None)
In [499]: rng_hourly.tz_localize("US/Eastern", ambiguous=[True, True, False, False])
Out[499]: 
DatetimeIndex(['2011-11-06 00:00:00-04:00', '2011-11-06 01:00:00-04:00',
               '2011-11-06 01:00:00-05:00', '2011-11-06 02:00:00-05:00'],
              dtype='datetime64[us, US/Eastern]', freq=None)
...
```
In [500]: dti = pd.date_range(start="2015-03-29 02:30:00", periods=3, freq="h")
# 2:30 is a nonexistent time
```
Localization of nonexistent times will raise an error by default.

```
In [501]: dti.tz_localize('Europe/Warsaw')
---------------------------------------------------------------------------
ValueError                                Traceback (most recent call last)
Cell In[501], line 1
...
-> 1117     new_dates = tzconversion.tz_localize_to_utc(
   ...
   1124 new_dates_dt64 = new_dates.view(f"M8[{self.unit}]")
   1125 dtype = tz_to_dtype(tz, unit=self.unit)
File pandas/_libs/tslibs/tzconversion.pyx:464, in pandas._libs.tslibs.tzconversion.tz_localize_to_utc()
...
DatetimeIndex(['2015-03-29 02:30:00', '2015-03-29 03:30:00',
               '2015-03-29 04:30:00'],
              dtype='datetime64[us]', freq='h')
In [503]: dti.tz_localize("Europe/Warsaw", nonexistent="shift_forward")
Out[503]: 
...
In [504]: dti.tz_localize("Europe/Warsaw", nonexistent="shift_backward")
Out[504]: 
DatetimeIndex(['2015-03-29 01:59:59.999999+01:00',
                      '2015-03-29 03:30:00+02:00',
                      '2015-03-29 04:30:00+02:00'],
              dtype='datetime64[us, Europe/Warsaw]', freq=None)
In [505]: dti.tz_localize("Europe/Warsaw", nonexistent=pd.Timedelta(1, unit="h"))
Out[505]: 
DatetimeIndex(['2015-03-29 03:30:00+02:00', '2015-03-29 03:30:00+02:00',
               '2015-03-29 04:30:00+02:00'],
              dtype='datetime64[us, Europe/Warsaw]', freq=None)
In [506]: dti.tz_localize("Europe/Warsaw", nonexistent="NaT")
Out[506]: 
...
```
In [507]: s_naive = pd.Series(pd.date_range("20130101", periods=3))
In [508]: s_naive
Out[508]: 
0   2013-01-01
1   2013-01-02
...
```
In [509]: s_aware = pd.Series(pd.date_range("20130101", periods=3, tz="US/Eastern"))
In [510]: s_aware
Out[510]: 
...
```
In [511]: s_naive.dt.tz_localize("UTC").dt.tz_convert("US/Eastern")
Out[511]: 
...
In [512]: s_aware.astype("datetime64[us, CET]")
Out[512]: 
...
```
In [515]: s_aware.to_numpy(dtype="datetime64[us]")
Out[515]: 
...
```
In [516]: pd.Series(s_aware.to_numpy(dtype=object))
Out[516]: 
0   2013-01-01 00:00:00-05:00
1   2013-01-02 00:00:00-05:00
2   2013-01-03 00:00:00-05:00
