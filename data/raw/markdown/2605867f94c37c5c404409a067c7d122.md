...
- Return the elements in the given *positional* indices along an axis.This means that we are not indexing according to actual values in the index attribute of the object. We are indexing according to the actual position of the element in the object. 
  - Parameters
    - **indices** array-like
...
that the return value is an actual copy. Starting with pandas 1.0,`take` always returns a copy, and the keyword is therefore
