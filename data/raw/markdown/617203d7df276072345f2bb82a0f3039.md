...
For an overview, see Index objects.
...
| `DatetimeIndex.as_unit` (unit) | Convert to a dtype with the given unit resolution. | 
...
| `TimedeltaIndex.inferred_freq` | (DEPRECATED) Return the inferred frequency of the index. | 
| `TimedeltaIndex.asi8` | Return Integer representation of the values. | 
| `TimedeltaIndex.unit` | The precision unit of the datetime data. | 
...
| `PeriodIndex.dayofweek` | (DEPRECATED) The day of the week with Monday=0, Sunday=6. | 
| `PeriodIndex.day_of_week` | The day of the week with Monday=0, Sunday=6. | 
| `PeriodIndex.dayofyear` | (DEPRECATED) The ordinal day of the year. | 
| `PeriodIndex.day_of_year` | The ordinal day of the year. | 
| `PeriodIndex.days_in_month` | The number of days in the month. | 
| `PeriodIndex.daysinmonth` | (DEPRECATED) The number of days in the month. | 
...
| `PeriodIndex.weekday` | (DEPRECATED) The day of the week with Monday=0, Sunday=6. | 
| `PeriodIndex.weekofyear` | The week ordinal of the year. | 
| `PeriodIndex.year` | The year of the period. | 
| `PeriodIndex.asi8` | Return Integer representation of the values. | 
