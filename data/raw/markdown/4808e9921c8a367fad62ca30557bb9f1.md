...
In [19]: id(idx.values)
Out[19]: 140304296946512
In [20]: id(idx.values)
Out[20]: 140304944111728
```
...
Out[49]: <pandas.io.formats.style.Styler at 0x7f9b22b76660>
```
...
File ~/work/pandas/pandas/pandas/core/frame.py:2032, in DataFrame.to_dict(self, orient, into, index)
   2028          defaultdict(<class 'list'>, {'col1': 2, 'col2': 0.75})]
   2029         """
   2030         from pandas.core.methods.to_dict import to_dict
   2031 
-> 2032         return to_dict(self, orient, into=into, index=index)
