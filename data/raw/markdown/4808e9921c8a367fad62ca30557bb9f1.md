...
In [19]: id(idx.values)
Out[19]: 139933455524912
In [20]: id(idx.values)
Out[20]: 139933488188848
```
...
Out[49]: <pandas.io.formats.style.Styler at 0x7f44cadb4ce0>
```
...
Out[59]: 
DatetimeIndex(['2015-11-18 15:30:00+05:30', '2015-11-18 15:30:00+05:30'],
              dtype='datetime64[us, UTC+05:30]', freq=None)
```
...
In [60]: pd.to_datetime(["2015-11-18 15:30:00+05:30",
   ...
   ....: 
Out[60]: 
DatetimeIndex(['2015-11-18 10:00:00+00:00', '2015-11-18 10:00:00+00:00'],
...
File ~/work/pandas/pandas/pandas/core/frame.py:2033, in DataFrame.to_dict(self, orient, into, index)
   2029          defaultdict(<class 'list'>, {'col1': 2, 'col2': 0.75})]
   2030         """
   2031         from pandas.core.methods.to_dict import to_dict
   2032 
-> 2033         return to_dict(self, orient, into=into, index=index)
File ~/work/pandas/pandas/pandas/core/methods/to_dict.py:258, in to_dict(df, orient, into, index)
    256 elif orient == "index":
    257     if not df.index.is_unique:
--> 258         raise ValueError("DataFrame index must be unique for orient='index'.")
    259     columns = df.columns.tolist()
    260     if are_all_object_dtype_cols:
...
Out[99]: 
DatetimeIndex(['1999-12-31 18:00:00-06:00'], dtype='datetime64[ns, US/Central]',
              freq=None)
```
...
Out[100]: 
DatetimeIndex(['2000-01-01 00:00:00-06:00'], dtype='datetime64[ns, US/Central]',
              freq=None)
```
