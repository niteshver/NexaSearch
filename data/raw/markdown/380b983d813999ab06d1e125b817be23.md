...
# 
 ![](https://huggingface.co/avatars/227757481480cf493cc2810ab9ee9397.svg) ⟨28⟩
WassupWuK⟨28⟩
/
...
Copy to bucket new
Use this model
### Instructions to use WassupWuK/MyAwesomeModel-TestRepo with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  * Libraries
  *  Transformers⟨36⟩
How to use WassupWuK/MyAwesomeModel-TestRepo with Transformers:

```
# Use a pipeline as a high-level helper
from transformers import pipeline

pipe = pipeline("feature-extraction", model="WassupWuK/MyAwesomeModel-TestRepo")
```
...
tokenizer = AutoTokenizer.from_pretrained("WassupWuK/MyAwesomeModel-TestRepo")
model = AutoModel.from_pretrained("WassupWuK/MyAwesomeModel-TestRepo", device_map="auto")
```
...
![MyAwesomeModel⟨51⟩]
* * *
 ![License](https://huggingface.co/WassupWuK/MyAwesomeModel-TestRepo/resolve/main/figures/fig2.png) ⟨52⟩
##   ⟨40⟩ 1. Introduction 
...
| --- | --- | --- | --- | --- | --- |  
| **Core Reasoning Tasks**  | Math Reasoning  | 0.510  | 0.535  | 0.521  | 0.797  |  
|   | Logical Reasoning  | 0.789  | 0.801  | 0.810  | 0.899  |  
|   | Common Sense  | 0.716  | 0.702  | 0.725  | 0.846  |  
| **Language Understanding**  | Reading Comprehension  | 0.671  | 0.685  | 0.690  | 0.842  |  
|   | Question Answering  | 0.582  | 0.599  | 0.601  | 0.786  |  
|   | Text Classification  | 0.803  | 0.811  | 0.820  | 0.899  |  
|   | Sentiment Analysis  | 0.777  | 0.781  | 0.790  | 0.897  |  
| **Generation Tasks**  | Code Generation  | 0.615  | 0.631  | 0.640  | 0.792  |  
|   | Creative Writing  | 0.588  | 0.579  | 0.601  | 0.775  |  
|   | Dialogue Generation  | 0.621  | 0.635  | 0.639  | 0.786  |  
|   | Summarization  | 0.745  | 0.755  | 0.760  | 0.897  |  
| **Specialized Capabilities**  | Translation  | 0.782  | 0.799  | 0.801  | 0.899  |  
|   | Knowledge Retrieval  | 0.651  | 0.668  | 0.670  | 0.842  |  
|   | Instruction Following  | 0.733  | 0.749  | 0.751  | 0.846  |  
|   | Safety Evaluation  | 0.718  | 0.701  | 0.725  | 0.846  |  
