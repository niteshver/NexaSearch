...
- 
    Air quality dataThis tutorial uses air quality data about `air_quality_long.csv` data set provides*FR04014* ,*BETR801* and*London Westminster* in respectively Paris, Antwerp and London.The air-quality data set has the following columns: 
  ...
  - parameter: the parameter measured by the sensor, either   - value: the measured value
...
- I want the mean concentrations for In [14]: air_quality.pivot_table( ....: values="value", index="location", columns="parameter", aggfunc="mean" ....: ) ....: Out[14]: parameter no2 pm25 location BETR801 26.950920 23.169492 FR04014 29.374284 NaN London Westminster 29.740050 13.443568 In the case of `pivot()` , the data is only rearranged. When multiple
...
```
- I want to collect all air quality In [18]: no_2 = no2_pivoted.melt(id_vars="date.utc") In [19]: no_2.head() Out[19]: date.utc location value 0 2019-04-09 01:00:00+00:00 BETR801 22.5 1 2019-04-09 02:00:00+00:00 BETR801 53.5 2 2019-04-09 03:00:00+00:00 BETR801 54.5 3 2019-04-09 04:00:00+00:00 BETR801 34.5 4 2019-04-09 05:00:00+00:00 BETR801 46.5 The `pandas.melt()` method on a`DataFrame` converts the data table from wide
