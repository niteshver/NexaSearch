...
# 
 ![](https://huggingface.co/avatars/a783e084ccf97cbd5c277eb94af1c166.svg) ⟨28⟩
AgentTest111⟨28⟩
/
...
Copy to bucket new
Use this model
### Instructions to use AgentTest111/MyAwesomeModel-TestRepo with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  * Libraries
  *  Transformers⟨36⟩
How to use AgentTest111/MyAwesomeModel-TestRepo with Transformers:

```
# Use a pipeline as a high-level helper
from transformers import pipeline

pipe = pipeline("feature-extraction", model="AgentTest111/MyAwesomeModel-TestRepo")
```
...
tokenizer = AutoTokenizer.from_pretrained("AgentTest111/MyAwesomeModel-TestRepo")
model = AutoModel.from_pretrained("AgentTest111/MyAwesomeModel-TestRepo", device_map="auto")
```
...
![MyAwesomeModel⟨51⟩]
* * *
 ![License](https://huggingface.co/AgentTest111/MyAwesomeModel-TestRepo/resolve/main/figures/fig2.png) ⟨52⟩
##   ⟨40⟩ 1. Introduction 
