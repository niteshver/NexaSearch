...
- Construct an IntervalIndex from an array of splits. The *breaks* array of length*N* is converted into*N-1* adjacent,
...
break values.
 ...
 Examples >>> pd.IntervalIndex.from_breaks([0, 1, 2, 3]) IntervalIndex([(0, 1], (1, 2], (2, 3]], dtype='interval[int64, right]')