...
File ~/work/pandas/pandas/pandas/core/frame.py:6847, in DataFrame.rename(self, mapper, index, columns, axis, copy, inplace, level, errors)
   6843             inplace = False
   6844 
   6845         self._check_copy_deprecation(copy)
   6846 
-> 6847         return super()._rename(
   6848             mapper=mapper,
   6849             index=index,
   6850             columns=columns,
