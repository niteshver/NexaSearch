...
# 
 ![](https://huggingface.co/avatars/3352b38307d69f6cf2b7cecd0c6bba2d.svg) ⟨28⟩
Vinay777777⟨28⟩
/
my-awesome-model⟨29⟩
like 0
...
Copy to bucket new
Use this model
### Instructions to use Vinay777777/my-awesome-model with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  * Libraries
  *  Transformers⟨36⟩
How to use Vinay777777/my-awesome-model with Transformers:

```
# Use a pipeline as a high-level helper
from transformers import pipeline

pipe = pipeline("feature-extraction", model="Vinay777777/my-awesome-model")
```
...
tokenizer = AutoTokenizer.from_pretrained("Vinay777777/my-awesome-model")
model = AutoModel.from_pretrained("Vinay777777/my-awesome-model", device_map="auto")
```
...
##  Paper for Vinay777777/my-awesome-model
