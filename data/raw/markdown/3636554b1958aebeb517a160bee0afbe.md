...
searching a parameter space for the best *Cross-validation: evaluating estimator performance* score.
...
- See *Parameter estimation using grid search with cross-validation* for an example of
...
*Pipeline: chaining estimators* describes building composite estimators whose
...
This can be done by using the `cross_validation.train_test_split`
utility function.
