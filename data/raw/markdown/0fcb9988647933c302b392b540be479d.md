...
- Return the median of the values over the requested axis. This computes the median of the values in each column (or row when `axis=1` ), skipping missing values by default.
  - Parameters:
