...
- 
DataFrame.ffill(*** ,*axis=None* ,*inplace=False* ,*limit=None* ,*limit_area=None* )[source]#
- Fill NA/NaN values by propagating the last valid observation to next valid. This method fills missing values using forward fill, where the last valid observation is propagated forward to fill the gaps. 
  - Parameters:
