...
|---|---|---|---|
| numexpr | 2.11.0 | performance | Accelerates certain numerical operations by using multiple cores as well as smart chunking and caching to achieve large speedups | 
| bottleneck | 1.5.0 | performance | Accelerates certain types of `nan` by using specialized cython routines to achieve large speedup. | 
| numba | 0.61.2 | performance | Alternative execution engine for operations that accept `engine="numba"` using a JIT compiler that translates Python functions to optimized machine code using the LLVM compiler. | 
...
| Dependency | Minimum Version | pip extra | Notes | 
|---|---|---|---|
| matplotlib | 3.10.5 | plot | Plotting library | 
| Jinja2 | 3.1.6 | output-formatting | Conditional formatting with DataFrame.style | 
...
| Dependency | Minimum Version | pip extra | Notes | 
|---|---|---|---|
| xlrd | 2.0.2 | excel | Reading for xls files (deprecated; use python-calamine) | 
| xlsxwriter | 3.2.5 | excel | Writing for xlsx files | 
...
| python-calamine | 0.4.0 | excel | Reading for xls/xlsx/xlsm/xlsb/xla/xlam/ods files | 
...
| Dependency | Minimum Version | pip extra | Notes | 
|---|---|---|---|
| BeautifulSoup4 | 4.13.4 | html | HTML parser for read_html | 
| html5lib | 1.1 | html | HTML parser for read_html | 
| lxml | 6.0.0 | html | HTML parser for read_html | 
...
| Dependency | Minimum Version | pip extra | Notes | 
|---|---|---|---|
| lxml | 6.0.0 | xml | XML parser for read_xml and tree builder for to_xml | 
...
| Dependency | Minimum Version | pip extra | Notes | 
|---|---|---|---|
| SQLAlchemy | 2.0.42 | postgresql, mysql, sql-other | SQL support for databases other than sqlite | 
| psycopg2 | 2.9.10 | postgresql | PostgreSQL engine for sqlalchemy | 
| pymysql | 1.1.1 | mysql | MySQL engine for sqlalchemy | 
| adbc-driver-postgresql | 1.7.0 | postgresql | ADBC Driver for PostgreSQL | 
| adbc-driver-sqlite | 1.7.0 | sql-other | ADBC Driver for SQLite | 
...
| Dependency | Minimum Version | pip extra | Notes | 
|---|---|---|---|
| PyTables | 3.10.2 | hdf5 | HDF5-based reading / writing | 
| zlib |  | hdf5 | Compression for HDF5 | 
| fastparquet | 2024.11.0 |  | Parquet reading / writing (pyarrow is default) | 
| pyarrow | 16.0.0 | parquet, feather | Parquet, ORC, and feather reading / writing | 
| PyIceberg | 0.9.1 | iceberg | Apache Iceberg reading / writing | 
| pyreadstat | 1.3.0 | spss | SPSS files (.sav) reading | 
...
| Dependency | Minimum Version | pip extra | Notes | 
|---|---|---|---|
| PyQt5 | 5.15.11 | clipboard | Clipboard I/O | 
| qtpy | 2.4.3 | clipboard | Clipboard I/O | 
