...
- Transform each element of a list-like to a row. This method expands list-like elements so that each item in the list gets its own row, while non-list-like elements remain unchanged. The index is duplicated for the expanded rows. 
  - Parameters:
