...
# 
 ![](https://huggingface.co/avatars/2ad0b5b17df2435c7c2ec8c4525c572d.svg) ⟨28⟩
Jani12067⟨28⟩
/
my-awesome-model⟨29⟩
like 0
...
Copy to bucket new
Use this model
### Instructions to use Jani12067/my-awesome-model with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  * Libraries
  *  Transformers⟨36⟩
How to use Jani12067/my-awesome-model with Transformers:

```
# Use a pipeline as a high-level helper
from transformers import pipeline

pipe = pipeline("feature-extraction", model="Jani12067/my-awesome-model")
```
...
tokenizer = AutoTokenizer.from_pretrained("Jani12067/my-awesome-model")
model = AutoModel.from_pretrained("Jani12067/my-awesome-model", device_map="auto")
```
...
##  Paper for Jani12067/my-awesome-model
